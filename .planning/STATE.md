...
Last activity: 2026-04-09 - P4 stays active and P4-06 clears stale lever conclusions whenever DemoAnswer or UI errors replace the active lever-snapshot payload.
...
- P4 is now the active product phase, `P4-01 首屏 Presenter Run Card`, `P4-02 演示场景预设`, `P4-03 状态图例与 truth boundary`, `P4-04 当前结论 reading rails`, and `P4-05 结果来源标记` are verified, and `P4-06 问答模式清空旧 lever 结论` is the next presenter-readiness plan under it.
