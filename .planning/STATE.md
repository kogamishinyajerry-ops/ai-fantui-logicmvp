...
status: Live Linear JER-247 JER-171 mypy baseline tranche 5 implementing
...
is the current coordination/validation tool mypy tranche: the touched tools are
focused strict-mypy clean, and the official wrapper moved from 4614 errors in
324 files to 4611 errors in 321 files while still blocked. Do not claim full
mypy clean.
