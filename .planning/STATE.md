...
status: Live Linear JER-242 release-candidate smoke pack implementing
last_updated: "2026-05-05T15:08:00.000+08:00"
...
product-readiness slice: add a local release-candidate smoke gate that starts
the demo server and probes the first operator flows without external services
or production-ready claims.
