...
| 9  | workbench_start.html:81 | "TRA / RA / N1k 等 lever 调参在 /demo.html，本期 ?intent= 还没把它合入" | surface-location | peer=src/well_harness/static/demo.html:68 (TRA lever input id="fan-tra-lever"); scope=src/well_harness/static/workbench.html (grep "fan-tra-lever" 0 hits) | [ANCHORED] |
...
| 11 | workbench_start.html:97 | "本期主面板还没有专门的 demo mode" | behavior (negative) | scope=src/well_harness/static/workbench.html (grep "demo-mode\|demo-stage" 0 hits); peer=src/well_harness/static/workbench.html:283-299 (view-mode-toggle-bar 存在，仅 beginner / expert 两键) | [ANCHORED] |
| 12 | workbench_start.html:103 | "wow_a/b/c 目前只在 tests/e2e/test_wow_a_causal_chain.py 里有，没有 UI 走读 surface" | data-source | peer=tests/e2e/test_wow_a_causal_chain.py:38-66 (BEAT_DEEP_PAYLOAD + test functions); scope=src/well_harness/static/workbench.html (grep "wow_a\|wow_b\|wow_c" 0 hits) | [ANCHORED] |
...
| 22 | workbench_start.html:170 | "本期主面板还没有专门的 trace-matrix 视图" | behavior (negative) | scope=src/well_harness/static/workbench.html (grep "trace-matrix\|data-trace" 0 hits); peer=src/well_harness/static/workbench.html:214-273 (preset section 存在，作对照) | [ANCHORED] |
