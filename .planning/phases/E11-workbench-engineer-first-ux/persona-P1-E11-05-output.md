2026-04-25T15:52:51.247464Z ERROR codex_core::codex: failed to load skill /Users/Zhuanz/.agents/skills/cfd-research-deerflow/SKILL.md: missing YAML frontmatter delimited by ---
2026-04-25T15:52:51.247542Z ERROR codex_core::codex: failed to load skill /Users/Zhuanz/.agents/skills/cfd-report-pretext/SKILL.md: missing YAML frontmatter delimited by ---
...
session id: 019dc558-0643-7cd2-a946-754d1d36883e
--------
user
You are Codex GPT-5.4 acting as **Persona P1 — Junior FCS Engineer** (Tier-A 5-persona pipeline, E11-05 sub-phase).
...
Focus on: code clarity, naming, regression risk, accidental side-effects, race conditions in the click handler, defensive coding around fetch failures.
...
Sign as: **P1 — Junior FCS Engineer (Tier-A, E11-05)**
codex
Reviewing PR #18 from the P1 lens. I’m loading the repo/memory context, checking the red-line diff first, then I’ll read every in-scope file and validate the click-path and fetch-failure behavior before I issue a verdict.
exec
...
exec
/bin/zsh -lc 'rg -n "LogicMVP|ai-fantui-logicmvp|E11-05|wow starter|workbench wow" /Users/Zhuanz/.codex/memories/MEMORY.md' in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
---
...
codex
Using `gsd-code-review` for the review workflow and `auto-compression-agent` to keep the inspection tight. I’ve finished the quick memory pass; next I’m validating the exact file scope against the red line and then reading the changed artifacts with line numbers.
  → Confirm red-line diff and changed-file scope between a17e744 and a02729a
  • Read all in-scope files and inspect diffs with line references
  • Run targeted validation for wow starter tests and, if useful, a live probe
  • Issue P1 review verdict with severity-tagged findings
exec
...
exec
/bin/zsh -lc 'git rev-parse --verify a17e744 && git rev-parse --verify a02729a && git diff --name-only a17e744..a02729a' in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
a17e7442230739f35df217747e4179555e0c0091
a02729a1de1a656748eff3c8c3094c97e5110ca8
...
exec
/bin/zsh -lc 'git diff --stat a17e744..a02729a' in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
 .../E11-05-SURFACE-INVENTORY.md                    |  51 ++++++
 .../PERSONA-ROTATION-STATE.md                      |   1 +
 src/well_harness/static/workbench.css              | 132 +++++++++++++++
 src/well_harness/static/workbench.html             | 106 ++++++++++++
 src/well_harness/static/workbench.js               | 111 +++++++++++++
 src/well_harness/static/workbench_start.html       |   7 +-
 tests/test_workbench_wow_starters.py               | 177 +++++++++++++++++++++
 7 files changed, 582 insertions(+), 3 deletions(-)

codex
The red-line check is clean: the diff only touches `static/`, `tests/`, and `.planning/`; no truth-engine files moved. I also see a dirty worktree from persona review artifacts, so I’m treating the commit range `a17e744..a02729a` as the review source of truth rather than local untracked files.
exec
/bin/zsh -lc 'wc -l src/well_harness/static/workbench.html src/well_harness/static/workbench.css src/well_harness/static/workbench.js src/well_harness/static/workbench_start.html tests/test_workbench_wow_starters.py .planning/phases/E11-workbench-engineer-first-ux/E11-05-SURFACE-INVENTORY.md .planning/phases/E11-workbench-engineer-first-ux/PERSONA-ROTATION-STATE.md' in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
     319 src/well_harness/static/workbench.html
    1958 src/well_harness/static/workbench.css
    3932 src/well_harness/static/workbench.js
     207 src/well_harness/static/workbench_start.html
     177 tests/test_workbench_wow_starters.py
      51 .planning/phases/E11-workbench-engineer-first-ux/E11-05-SURFACE-INVENTORY.md
      13 .planning/phases/E11-workbench-engineer-first-ux/PERSONA-ROTATION-STATE.md
    6657 total

exec
/bin/zsh -lc 'git diff --unified=80 a17e744..a02729a -- src/well_harness/static/workbench.html src/well_harness/static/workbench.css src/well_harness/static/workbench.js src/well_harness/static/workbench_start.html tests/test_workbench_wow_starters.py .planning/phases/E11-workbench-engineer-first-ux/E11-05-SURFACE-INVENTORY.md .planning/phases/E11-workbench-engineer-first-ux/PERSONA-ROTATION-STATE.md' in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
diff --git a/.planning/phases/E11-workbench-engineer-first-ux/E11-05-SURFACE-INVENTORY.md b/.planning/phases/E11-workbench-engineer-first-ux/E11-05-SURFACE-INVENTORY.md
new file mode 100644
index 0000000..6b7c118
--- /dev/null
+++ b/.planning/phases/E11-workbench-engineer-first-ux/E11-05-SURFACE-INVENTORY.md
@@ -0,0 +1,51 @@
...
+   Top-of-/workbench placement so the demo presenter has a one-click
+   走读 entrypoint to BEAT_DEEP_PAYLOAD / Monte-Carlo / Reverse-Diagnose
+   without typing payloads by hand. */
+.workbench-wow-starters {
+  margin-bottom: 1rem;
+  padding: 1rem 1.1rem;
...
+}
+
+.workbench-wow-starters-header {
+  margin-bottom: 0.85rem;
+}
+
+.workbench-wow-starters-header h2 {
+  margin: 0.2rem 0 0.35rem;
+  font-size: 1.15rem;
+  color: #d8ecff;
+}
+
+.workbench-wow-starters-sub {
+  margin: 0;
+  color: rgba(206, 223, 236, 0.78);
+  font-size: 0.85rem;
+}
+
+.workbench-wow-starters-grid {
+  display: grid;
...
+}
+
+.workbench-wow-card header {
+  display: flex;
+  align-items: baseline;
+  gap: 0.55rem;
+}
+
+.workbench-wow-card h3 {
+  margin: 0;
+  font-size: 1rem;
+  color: #e6f1ff;
+}
...
+}
+
+.workbench-wow-card-desc {
+  margin: 0;
+  color: rgba(206, 223, 236, 0.84);
+  font-size: 0.85rem;
+  line-height: 1.45;
+}
+
+.workbench-wow-card-desc code {
...
+}
+
+.workbench-wow-run-button:hover:not([disabled]) {
+  background: rgba(120, 200, 255, 0.28);
+}
+
+.workbench-wow-run-button[disabled] {
+  opacity: 0.55;
+  cursor: progress;
+}
+
...
index 22c59ee..c214228 100644
--- a/src/well_harness/static/workbench.js
+++ b/src/well_harness/static/workbench.js
@@ -3712,110 +3712,221 @@ function installToolbarHandlers() {
 }
...
diff --git a/src/well_harness/static/workbench_start.html b/src/well_harness/static/workbench_start.html
index 6d7cc22..0e57978 100644
--- a/src/well_harness/static/workbench_start.html
+++ b/src/well_harness/static/workbench_start.html
@@ -1,193 +1,194 @@
 <!DOCTYPE html>
 <html lang="zh-CN">
 <head>
 <meta charset="UTF-8">
 <meta name="viewport" content="width=device-width,initial-scale=1">
 <title>Workbench · 选择你的工作台入口</title>
 <link rel="stylesheet" href="/unified-nav.css">
 <link rel="stylesheet" href="/workbench_start.css">
 </head>
 <body class="unified-nav-enabled" data-nav-current="workbench-start">
 ...
 <header class="unified-nav" role="navigation" aria-label="FANTUI LogicMVP 主导航">
   ...
   <div class="unified-nav-groups">
     <div class="unified-nav-group">
       ...
       <a href="/workbench/start" class="unified-nav-link" data-nav-key="workbench-start" data-current="true">入口选择</a>
       <a href="/workbench" class="unified-nav-link" data-nav-key="workbench">完整面板</a>
     </div>
   </div>
 </header>
 
 <main class="ws-main" id="workbench-start-main">
   <section class="ws-hero" aria-labelledby="ws-hero-title">
     <h1 id="ws-hero-title">先告诉我你今天来做什么</h1>
     <p>
       <strong>Workbench</strong> 是同一个 3 列面板，今天会承载 5 类工作。
       下面 6 张卡片各自把你带进 <code>/workbench</code> 主面板，并附一个稳定的
       <code>?intent=</code> 标记。 <em>本期 (E11-02) 还没有按 intent 自动重排面板</em>——
       标记落地是为了 E11-05 / E11-08 / E11-11 这几期能基于它做角色化裁剪。
       想跳过引导直接看完整面板？ <a href="/workbench" class="ws-skip-link">/workbench →</a>
     </p>
   </section>
 
   <section class="ws-axes" aria-labelledby="ws-axes-title">
     <h2 id="ws-axes-title">这页在按"角色 + 工作意图"两个维度组织入口</h2>
     <ul>
       <li>
         <strong>P1–P5</strong> 是 E11-01 baseline 5-persona review 里的工程角色
         （Junior FCS / Senior FCS / Demo Presenter / V&amp;V / Apps Engineer），
         每个 persona 在主面板里有自己最常落地的起手任务。
       </li>
       <li>
         <strong>KOGAMI</strong> 不是 persona，是项目内部的<em>审批权限</em>角色（仅 Kogami 可签发 proposal）。
         与 P1–P5 同列展示，是因为审批入口和上面五种工作一样来自 Workbench。
       </li>
     </ul>
   </section>
 
   <section class="ws-tiles" aria-label="角色 + 意图入口">
     <a href="/workbench?intent=learn-demo"
        class="ws-tile"
        data-persona="P1"
        data-intent="learn-demo"
        id="ws-tile-learn-demo">
       <span class="ws-tile-kind">学习与演示</span>
       <h2 class="ws-tile-title">跑 4 张一键验收预设</h2>
       <p class="ws-tile-subtitle">P1 · Junior FCS · 30 分钟内上手</p>
       <p class="ws-tile-desc">
         落到 <code>/workbench</code>「一键预设验收卡」。 当前 4 张：
         <em>通过并留档 / 阻塞演示 / 快速通过 / 留档复跑</em>，每张点完会自动跑
         intake → bundle 真实链路；其中 ready_archived 与 archive_retry 还会
         落 archive 目录，blocked_follow_up 与 ready_preview 不落 archive。
         不要求先碰 JSON。
       </p>
       <ul class="ws-tile-bullets">
         <li>4 张预设：ready_archived / blocked_follow_up / ready_preview / archive_retry</li>
         <li>archiveBundle: true 仅 2/4（ready_archived + archive_retry）</li>
-        <li>wow_a/b/c 起手卡片是 E11-05 范围，本期暂未上线</li>
+        <li>wow_a/b/c 起手卡片已上线（E11-05），见 <code>/workbench</code> 顶部「起手卡」</li>
       </ul>
       <span class="ws-tile-arrow">→</span>
     </a>
 
     <a href="/workbench?intent=engineer-probe"
        class="ws-tile"
        data-persona="P2"
        data-intent="engineer-probe"
        id="ws-tile-engineer-probe">
       <span class="ws-tile-kind">工程师调试</span>
       <h2 class="ws-tile-title">读 3 列 shell + Raw JSON 抽屉</h2>
       <p class="ws-tile-subtitle">P2 · Senior FCS · 真值只读 / 提案受签</p>
       <p class="ws-tile-desc">
         落到 <code>/workbench</code> 的 control / document / circuit 三列 shell + 「开发调试 / Raw JSON」
         抽屉。 改动 spec 不会改真值，只能转成 ticket / proposal 走签批。
         TRA / RA / N1k 等 lever 调参在 <code>/demo.html</code>，本期 <code>?intent=</code> 还没把它合入。
       </p>
       <ul class="ws-tile-bullets">
         <li>truth-engine 是 read-only（红线见底部）</li>
         <li>顶部 ticket / identity chrome 默认显示，可读不可改</li>
         <li>L1–L4 着色 + 认证链 banner 在 E11-06/07 上线</li>
       </ul>
       <span class="ws-tile-arrow">→</span>
     </a>
 
     <a href="/workbench?intent=demo-stage"
        class="ws-tile"
        data-persona="P3"
        data-intent="demo-stage"
        id="ws-tile-demo-stage">
       <span class="ws-tile-kind">立项 / 汇报演示</span>
       <h2 class="ws-tile-title">用「通过并留档」预设走 happy path</h2>
       <p class="ws-tile-subtitle">P3 · Demo Presenter · 上台前最后过一遍</p>
       <p class="ws-tile-desc">
         本期主面板还没有专门的 demo mode。 暂时推荐：先点
         <em>「一键通过验收」（ready_archived）</em> 走通 happy path，
         再点 <em>「一键看阻塞态」（blocked_follow_up）</em> 演示 clarification gate。
         反推逻辑 lever-driven 演示（TRA / RA / N1k）在 <code>/demo.html</code>；
-        wow_a/b/c 目前只在 <code>tests/e2e/test_wow_a_causal_chain.py</code> 里有，没有 UI 走读 surface。
+        wow_a/b/c 起手卡 已在 <code>/workbench</code> 顶部上线（E11-05），可以一键走读
+        BEAT_DEEP_PAYLOAD / Monte-Carlo / Reverse-Diagnose。
       </p>
       <ul class="ws-tile-bullets">
         <li>建议演示前隐藏浏览器侧栏 + 关闭 Approval Center 抽屉</li>
         <li>"一键留档复跑" 适合演示同秒重复点也不崩</li>
-        <li>无-chrome demo mode + UI wow_a 走读 进入 E11-05/08 范围</li>
+        <li>无-chrome demo mode 进入 E11-08 范围（wow_a 走读 已 E11-05 完成）</li>
       </ul>
       <span class="ws-tile-arrow">→</span>
     </a>
 
     <a href="/workbench?intent=customer-repro"
        class="ws-tile"
        data-persona="P5"
        data-intent="customer-repro"
        id="ws-tile-customer-repro">
       <span class="ws-tile-kind">客户问题复现</span>
       <h2 class="ws-tile-title">填 9 个 knowledge 字段</h2>
       <p class="ws-tile-subtitle">P5 · Apps Engineer · intake → bundle → archive</p>
       <p class="ws-tile-desc">
         落到 <code>/workbench</code> 的 knowledge 区（"Resolution / Knowledge 字段"折叠面板）。 当前 schema 是 9 字段：
         Observed Symptoms / Evidence Links / Confirmed Root Cause / Repair Action / Validation After Fix /
         Residual Risk / Suggested Logic Change / Reliability Gain Hypothesis / Guardrail Note。
         客户邮件原文 → ticket payload 的字段映射工具是 E11-08 范围，
         本期暂时手抄进 Evidence Links。
       </p>
       <ul class="ws-tile-bullets">
         <li>knowledge 字段已经在主面板渲染（dt/dd 列表）</li>
         <li>customer_quote / repro_recipe / screenshot_refs 等扩展字段是 E11-08 范围</li>
         <li>提交后转到 intake → bundle 真实链路，不新增第二套规则</li>
       </ul>
       <span class="ws-tile-arrow">→</span>
     </a>
 
     <a href="/workbench?intent=approval-review#approval-center-entry"
        class="ws-tile"
        data-persona="KOGAMI"
        data-intent="approval-review"
        id="ws-tile-approval-review">
       <span class="ws-tile-kind">提案审核（Kogami）</span>
       <h2 class="ws-tile-title">Approval Center · 静态 shell 占位</h2>
       <p class="ws-tile-subtitle">label 上写 Kogami-only · 角色判定逻辑未实现</p>
       <p class="ws-tile-desc">
         落到 <code>/workbench</code> 底栏的 Approval Center 入口。 当前
         是静态 HTML：3 道 lane（Pending / Accept / Reject）+ 两个按钮 + 一句
         "Approval actions are Kogami-only" 的告示文案。 <strong>workbench.js
         没有 approval-action handler</strong>，按钮点了不会落账（对 Kogami 也不会）。
         hash-chain 查阅 / SHA 分组 / JSONL 导出 / 状态过滤 / 角色判定都是 E11-08 范围，
         本期只是给后续 phase 留好 selector 锚点。
       </p>
       <ul class="ws-tile-bullets">
         <li>data-approval-role="KOGAMI" + data-approval-action 锚点已就位</li>
         <li>Pending lane 当前只是占位文案，没有真实 proposal 列表</li>
         <li>角色判定 / 实际签批落账逻辑完全在 E11-08 后</li>
       </ul>
       <span class="ws-tile-arrow">→</span>
     </a>
 
     <a href="/workbench?intent=vv-trace"
        class="ws-tile"
        data-persona="P4"
        data-intent="vv-trace"
        id="ws-tile-vv-trace">
       <span class="ws-tile-kind">V&amp;V 适航追溯</span>
       <h2 class="ws-tile-title">沿 intake → bundle → archive 走读</h2>
       <p class="ws-tile-subtitle">P4 · QA / V&amp;V · DO-178C 风格审计</p>
       <p class="ws-tile-desc">
         本期主面板还没有专门的 trace-matrix 视图。 当前能做的：
         从某个 acceptance preset 跑出 bundle，去 archive 包里读结果，
         对照 <code>controller.py</code> + <code>adapters/*.py</code> 找 requirement 引用。
         CSV / JSONL trace 导出在 E11-09 后才上线。
       </p>
       <ul class="ws-tile-bullets">
         <li>archive package 自带 timestamp + slug 目录 + SHA256 文件完整性哈希（不是 git commit SHA）</li>
         <li>truth-engine SHA / adversarial 8/8 / e2e 状态条进入 E11-06 范围</li>
         <li>本期产出物均为内部研究证据，不构成适航合规声明</li>
       </ul>
       <span class="ws-tile-arrow">→</span>
     </a>
   </section>
 
   <section class="ws-redline" aria-labelledby="ws-redline-title">
     <h2 id="ws-redline-title">红线 · 你点哪一张都不会改的东西</h2>
     <ul>
       <li><code>controller.py</code> · 19-node truth engine · 4 logic gates — <strong>read-only</strong></li>
       <li><code>adapters/*.py</code> 真值出口 — <strong>read-only</strong></li>
       <li>已签 audit event 的 hash chain — <strong>append-only</strong></li>
diff --git a/tests/test_workbench_wow_starters.py b/tests/test_workbench_wow_starters.py
new file mode 100644
index 0000000..27bebea
--- /dev/null
...
codex
I’ve got the commit diff and the red-line boundary. The remaining work is reading the full file bodies, not just the hunks, because the main risk here is interaction with existing shared `workbench.js` boot logic rather than the new lines in isolation.
exec
...
exec
/bin/zsh -lc "nl -ba src/well_harness/static/workbench.html | sed -n '221,380p'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba tests/test_workbench_wow_starters.py | sed -n '1,240p'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
...
exec
/bin/zsh -lc 'rg -n "workbench-wow|workbench-trust-banner|workbench-collab-topbar|workbench-collab-grid|workbench-toolbar-button|@media" src/well_harness/static/workbench.css' in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
...
exec
/bin/zsh -lc "rg -n \"workbench-wow|WOW_SCENARIOS|runWowScenario|installWowStarters|DOMContentLoaded|installFeedbackModeAffordance|syncTrustBannerForMode|fetch\\(|workbench-system-select|sessionStorage|workbench-packet-json\" src/well_harness/static/workbench.js" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .planning/phases/E11-workbench-engineer-first-ux/E11-05-SURFACE-INVENTORY.md | sed -n '1,120p'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
...
codex
I’ve finished the smaller files and verified the planning docs align with the code diff. I’m chunk-reading the full shared CSS/JS now, because the main question is whether the new starter-card boot path collides with the existing shell and bundle-page logic.
exec
/bin/zsh -lc "nl -ba src/well_harness/static/workbench.css | sed -n '1,500p'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba src/well_harness/static/workbench.css | sed -n '501,1000p'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
exec
/bin/zsh -lc "nl -ba src/well_harness/static/workbench.css | sed -n '1501,2050p'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
exec
/bin/zsh -lc "nl -ba src/well_harness/static/workbench.css | sed -n '1001,1500p'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba src/well_harness/static/workbench.js | sed -n '3501,3932p'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
exec
...
codex
I’ve finished the full-file read. I’m now checking the referenced e2e payload contracts and running the targeted wow-starter test file, because the strongest likely findings here are either contract-lock gaps or failure-path gaps rather than obvious truth-engine violations.
exec
/bin/zsh -lc "nl -ba tests/e2e/test_wow_a_causal_chain.py | sed -n '1,140p'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
...
exec
/bin/zsh -lc 'rg -n "AbortController|timeout|Failed to fetch|network error|response.ok" src/well_harness/static/workbench.js' in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
376:    if (!response.ok) {
1544:    if (!response.ok) {
2190:    if (!response.ok) {
...
exec
/bin/zsh -lc 'rg -n "monte-carlo|seed|n_trials|system_id|def _run|deploy_confirmed|max_results|diagnosis/run" tests/e2e/test_wow_b_monte_carlo.py tests/e2e/test_wow_c_reverse_diagnose.py' in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
tests/e2e/test_wow_b_monte_carlo.py:3:Locks the observable contract of /api/monte-carlo/run against a live
tests/e2e/test_wow_b_monte_carlo.py:5:deterministic seeding.
tests/e2e/test_wow_b_monte_carlo.py:14:    "n_trials", "n_failures", "success_rate",
tests/e2e/test_wow_b_monte_carlo.py:15:    "mean_cycles_to_failure", "mtbf_cycles", "seed",
tests/e2e/test_wow_b_monte_carlo.py:25:def _run(api_post, base_url, n_trials, seed=42):
tests/e2e/test_wow_b_monte_carlo.py:26:    return api_post(base_url, "/api/monte-carlo/run",
tests/e2e/test_wow_b_monte_carlo.py:27:                    {"system_id": "thrust-reverser", "n_trials": n_trials, "seed": seed})
tests/e2e/test_wow_b_monte_carlo.py:36:    assert not missing, f"monte-carlo response missing keys: {missing}"
tests/e2e/test_wow_b_monte_carlo.py:47:    assert body["n_trials"] == 10000
tests/e2e/test_wow_b_monte_carlo.py:57:    # Consistency: n_failures + successes = n_trials
tests/e2e/test_wow_b_monte_carlo.py:58:    assert body["n_failures"] + round(sr * body["n_trials"]) == body["n_trials"] or \
tests/e2e/test_wow_b_monte_carlo.py:59:           abs(body["n_failures"] - (1 - sr) * body["n_trials"]) < 1
tests/e2e/test_wow_b_monte_carlo.py:77:def test_wow_b_is_deterministic_under_fixed_seed(demo_server, api_post):
tests/e2e/test_wow_b_monte_carlo.py:78:    """Same seed → byte-identical body (critical for rehearsal repeatability)."""
...
tests/e2e/test_wow_b_monte_carlo.py:82:    assert b1 == b2, "Monte Carlo must be deterministic under fixed seed"
tests/e2e/test_wow_b_monte_carlo.py:86:def test_wow_b_n_trials_zero_is_clamped_to_min(demo_server, api_post):
tests/e2e/test_wow_b_monte_carlo.py:87:    """Known clamp behavior: n_trials=0 is auto-clamped to 1 (graceful, not 400).
tests/e2e/test_wow_b_monte_carlo.py:93:    assert body["n_trials"] >= 1
tests/e2e/test_wow_b_monte_carlo.py:97:def test_wow_b_n_trials_overflow_is_clamped_to_max(demo_server, api_post):
tests/e2e/test_wow_b_monte_carlo.py:100:    assert body["n_trials"] <= 10000
...
tests/e2e/test_wow_c_reverse_diagnose.py:29:        "system_id": "thrust-reverser",
tests/e2e/test_wow_c_reverse_diagnose.py:30:        "outcome": "deploy_confirmed",
tests/e2e/test_wow_c_reverse_diagnose.py:31:        "max_results": 10,
...
tests/e2e/test_wow_c_reverse_diagnose.py:44:        "system_id": "thrust-reverser",
tests/e2e/test_wow_c_reverse_diagnose.py:45:        "outcome": "deploy_confirmed",
tests/e2e/test_wow_c_reverse_diagnose.py:46:        "max_results": 5,
tests/e2e/test_wow_c_reverse_diagnose.py:58:    status, body = api_post(demo_server, "/api/diagnosis/run", {
tests/e2e/test_wow_c_reverse_diagnose.py:59:        "system_id": "thrust-reverser",
tests/e2e/test_wow_c_reverse_diagnose.py:73:    status, body = api_post(demo_server, "/api/diagnosis/run", {
tests/e2e/test_wow_c_reverse_diagnose.py:74:        "system_id": "thrust-reverser",
tests/e2e/test_wow_c_reverse_diagnose.py:76:        "max_results": 1,
tests/e2e/test_wow_c_reverse_diagnose.py:84:    status, body = api_post(demo_server, "/api/diagnosis/run", {
tests/e2e/test_wow_c_reverse_diagnose.py:85:        "system_id": "thrust-reverser",
tests/e2e/test_wow_c_reverse_diagnose.py:98:    status, body = api_post(demo_server, "/api/diagnosis/run", {
tests/e2e/test_wow_c_reverse_diagnose.py:99:        "system_id": "thrust-reverser",
...
tests/e2e/test_wow_c_reverse_diagnose.py:108:        "system_id": "thrust-reverser",
tests/e2e/test_wow_c_reverse_diagnose.py:109:        "outcome": "deploy_confirmed",
tests/e2e/test_wow_c_reverse_diagnose.py:110:        "max_results": 3,
...
server = <http.server.ThreadingHTTPServer object at 0x10b022790>
...
self = <http.client.HTTPResponse object at 0x10aad4ee0>
...
----------------------------------------
Exception occurred during processing of request from ('127.0.0.1', 63134)
...
server = <http.server.ThreadingHTTPServer object at 0x10b112590>
...
self = <http.client.HTTPResponse object at 0x10aad6650>
...
----------------------------- Captured stderr call -----------------------------
----------------------------------------
Exception occurred during processing of request from ('127.0.0.1', 63138)
Traceback (most recent call last):
  File "/opt/homebrew/Cellar/python@3.11/3.11.15/Frameworks/Python.framework/Versions/3.11/lib/python3.11/socketserver.py", line 691, in process_request_thread
    self.finish_request(request, client_address)
  File "/opt/homebrew/Cellar/python@3.11/3.11.15/Frameworks/Python.framework/Versions/3.11/lib/python3.11/socketserver.py", line 361, in finish_request
...
2 failed, 8 passed in 2.05s

codex
The targeted file didn’t come back clean on this branch. I’m pulling the failing traceback now; if the failure is in the new wow-starter tests themselves rather than the implementation, that changes the review severity.
codex
The local evidence doesn’t match the supplied verification note. On the default interpreter in this worktree, the new test file fails 2/10 because the server-side wow_b/wow_c imports need `numpy` and `jsonschema`; I’m checking whether that’s a real regression in the test design or just the wrong runner/environment before I lock severity.
exec
/bin/zsh -lc "rg -n \"numpy|jsonschema|pytest|uv run|.venv|python -m pytest\" pyproject.toml requirements*.txt README* docs -g '"'!**/node_modules/**'"'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 exited 1 in 0ms:
...
exec
/bin/zsh -lc "rg --files -g 'pyproject.toml' -g 'requirements*.txt' -g 'uv.lock' -g 'Pipfile' -g 'poetry.lock'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
total 128
...
drwxr-xr-x@ 16 Zhuanz  staff    512 Apr 25 23:53 .git
...
drwxr-xr-x@  3 Zhuanz  staff     96 Apr 18 23:57 src
drwxr-xr-x@  4 Zhuanz  staff    128 Apr 25 14:12 templates
drwxr-xr-x@ 81 Zhuanz  staff   2592 Apr 25 23:47 tests
...
exec
/bin/zsh -lc "python3 -c 'import sys; print(sys.executable)'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
...
exec
/bin/zsh -lc "find .. -maxdepth 2 -type d -name '.venv' -o -type f -name 'uv.lock'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
exec
/bin/zsh -lc 'rg -n "uv run|pytest|python -m pytest|numpy|jsonschema" README.md docs pyproject.toml' in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
...
docs/c919_etras/traceability_matrix.md:151:| Default suite (non-e2e) | `PYTHONPATH=src python -m pytest tests/` | 747 passed, 1 skipped, 49 deselected in ~61 s | 63 new (`test_c919_etras_adapter.py`) + 684 pre-existing |
docs/c919_etras/traceability_matrix.md:152:| Opt-in e2e | `PYTHONPATH=src python -m pytest tests/ -m e2e` | 49 passed, 748 deselected in ~1.5 s | All 49 e2e including `test_resilience_adversarial_truth_engine_still_passes` |
docs/onboarding/README.md:52:  - `jsonschema` — required only if you want schema validation in the validation suite
docs/onboarding/README.md:253:The validation script (`validate_landing_gear_full_pipeline.py`) also performs JSON schema validation against all four output schemas. Install the optional `jsonschema` dependency to enable this:
docs/onboarding/README.md:256:pip install jsonschema
docs/onboarding/README.md:281:**To skip schema validation** (when `jsonschema` is not installed), the script automatically detects the missing dependency and exits gracefully with status 0 and a `skip` reason.
docs/onboarding/THIRD_SYSTEM_CASE_STUDY.md:81:jsonschema was installed and active; all schema validations passed.
docs/unfreeze/P17-application-draft.md:35:**证据强度**：639 主路径 passed、38+11 opt-in e2e passed、8/8 adversarial 全部基于 GitHub main + 本 PR 的可验证 pytest 输出，无编造数字。
docs/unfreeze/P17-application-draft.md:70:### 3.1 测试底盘（逐项可追溯到 git log / pytest 输出）
docs/unfreeze/P17-application-draft.md:74:| pytest 默认路径 | 561 passed | **639 passed + 1 skipped** | +78，0 回归 | 4fc4db5 |
docs/unfreeze/P17-application-draft.md:114:- `9b853f1` chore(P20.0-infra)：pytest marker `e2e` + addopts `-m 'not e2e'` + tests/e2e/ 骨架 + fixtures/schema_snapshot.json + adversarial 参数化
docs/unfreeze/P17-application-draft.md:165:| R-02 | 演示加固被当"真解冻"木马 | 有人以"演示需要"为由推 src/ 业务改动 | 冻结边界侵蚀 | P20.0 / 本 PR 已强制 src/ 业务改动=0；本申请不提 src/ 计划 | **测试**：CI pytest 默认路径 ≠ 639 即阻断 PR merge |
docs/unfreeze/P17-application-draft.md:214:7. ✅ 本文件所有数字**可追溯**（commit hash / pytest 输出 / Notion 页面 URL）
docs/unfreeze/P17-application-draft.md:219:- pytest 主路径维持 639（或增加，不减少）
docs/unfreeze/P17-application-draft.md:231:  - 证据链具体条目（commit hash / pytest 输出）
docs/workbench/xpassed-audit-20260425.md:3:**Run command:** `python3 -m pytest --runxfail -v --no-header`
docs/workbench/xpassed-audit-20260425.md:9:$ python3 -m pytest tests/test_p43_authority_contract.py -v --no-header
...
docs/workbench/xpassed-audit-20260425.md:44:- **PROMOTE: 12** (delete the `@pytest.mark.xfail(...)` decorator; keep the test body and assertion message)
docs/workbench/xpassed-audit-20260425.md:58:- Does **not** modify any `@pytest.mark.xfail` decorator.
docs/workbench/inherited-logic4-blocker-investigation.md:23:All three rounds were executed on the same sandbox (Python 3.9.6, pytest 7.4.4) on 2026-04-25 UTC. Port 8799 was reaped before every run. Test command (identical across rounds):
docs/workbench/inherited-logic4-blocker-investigation.md:26:python3 -m pytest "tests/e2e/test_wow_a_causal_chain.py::test_wow_a_beat_deep_activates_logic2_and_logic3" -v -m e2e --no-header
docs/workbench/inherited-logic4-blocker-investigation.md:89:# (runner = pytest on the single failing case, exit-code-driven)
docs/workbench/inherited-logic4-blocker-investigation.md:200:- `runs/xpassed_audit_20260425T045925Z.txt` — full `pytest --runxfail -v` stdout (T2)
docs/provenance/sha_registry.yaml:5:# Enforced by scripts/verify_provenance_hashes.py via pytest default lane
docs/presentations/pitch-ready-demo.md:184:- 634 pytest：每次push自动运行
docs/co-development/security-review-template.md:28:| 6 | 是否通过主 pytest + e2e lane？ | 回归 | `pytest` 658+/1skip、e2e 49/49 | 有新的 red 或 xfail |
docs/demo/pre-pitch-readiness-report.md:26:- pytest suite (run `python3 -m pytest`)
docs/presentations/demo-talking-points.md:79:> 对外审查完整可追溯：每次代码修改都经过Opus-4.7 Gate、8/8对抗契约测试、634个pytest。
docs/co-development/roadmap-2026H2.md:40:- 端到端 pytest（可模拟典型故障场景）
docs/co-development/roadmap-2026H2.md:45:- 主 pytest + e2e + 对抗 全绿
docs/demo/preflight_checklist.md:43:| 11 | 主 pytest 绿 | `python3 -m pytest --tb=short -q 2>&1 | tail -3` | `passed` 数 ≥ 658 | 看回归，决定是否回退 |
docs/demo/preflight_checklist.md:44:| 12 | e2e 绿 | `python3 -m pytest -m e2e --tb=short -q 2>&1 | tail -3` | `49 passed` | 单独 debug 失败 case |
docs/demo/preflight_checklist.md:87:python3 -m pytest --tb=short -q 2>&1 | tail -3
docs/demo/preflight_checklist.md:88:python3 -m pytest -m e2e --tb=short -q 2>&1 | tail -3
docs/demo/faq.md:82:2. **测试层：** 主 pytest 658 通过 + 1 合法 skip / e2e 49 通过 / 对抗 8 通过。
docs/demo/local_model_poc.md:104:| R5 对抗守门 | Ollama 输出经相同 JSON schema + VALID_ACTION_TYPES / VALID_RESPONSE_TYPES 校验，不可信 payload 直接降级为默认响应。`archive/shelved/llm-features/tests/test_llm_client.py` 19 tests + 主 pytest 658 pass + e2e 49/49 + adversarial 8/8。 |
docs/architecture/constitution-v2.md:52:- ✅ Three-track test discipline — pytest 默认 684/1skip + opt-in e2e 49 + adversarial 8/8（P31 re-land baseline 2026-04-20）
docs/coordination/claude_code_pivot_analysis_report.md:62:  - `.github/workflows/gsd-automation.yml` 中 `validation` 只安装了 `jsonschema pytest`
docs/coordination/claude_code_pivot_analysis_report.md:63:  - `pyproject.toml` 的 `.[dev]` 依赖还包含 `numpy`、`pyyaml`、`pytest-subtests`
docs/coordination/claude_code_pivot_analysis_report.md:74:  - dashboard 仍写旧测试基线 `pytest 796 passed`
docs/demo/pitch-citations-audit.md:68:- 数字 claim（pytest 658→662 等）— 刻意忽略，rot 噪音
docs/coordination/claude_code_pivot_handoff_prompt.md:38:- 这个 `validation` 红灯的核心原因是 workflow 只安装了 `jsonschema pytest`，没有覆盖 `pyproject.toml` 中 `.[dev]` 依赖里的 `numpy` / `pyyaml` / `pytest-subtests`
docs/demo/pitch_script.md:189:> **每条原则都有 pytest 测试 + 真跑证据。**主 pytest 658 个测试通过，1 个
docs/demo/pitch_script.md:226:- 凡本稿里写"测试通过"——必有 `pytest` 输出截图或 CI 记录。
docs/coordination/archive/qa-report-history.md:1757:  - `PYTHONPATH=src python3 -m unittest tests.test_demo.DemoIntentLayerTests.test_demo_answer_schema_standalone_script_smoke tests.test_demo.DemoIntentLayerTests.test_demo_answer_schema_standalone_script_forced_skip tests.test_demo.DemoIntentLayerTests.test_demo_answer_schema_standalone_script_json_pass_output tests.test_demo.DemoIntentLayerTests.test_demo_answer_schema_standalone_script_json_forced_skip_output tests.test_demo.DemoIntentLayerTests.test_optional_jsonschema_validates_demo_json_payloads_when_installed`
docs/coordination/archive/qa-report-history.md:1798:  - `PYTHONPATH=src python3 -m unittest tests.test_demo.DemoIntentLayerTests.test_demo_answer_schema_standalone_script_smoke tests.test_demo.DemoIntentLayerTests.test_demo_answer_schema_standalone_script_forced_skip tests.test_demo.DemoIntentLayerTests.test_optional_jsonschema_validates_demo_json_payloads_when_installed`
docs/coordination/archive/qa-report-history.md:1810:  - 安装 `jsonschema` 时，真实校验三条 demo JSON payload：
docs/coordination/archive/qa-report-history.md:1838:  - `PYTHONPATH=src python3 -m unittest tests.test_demo.DemoIntentLayerTests.test_optional_jsonschema_validates_demo_json_payloads_when_installed`
...
docs/coordination/archive/qa-report-history.md:1851:  - 缺少 `jsonschema` 时会明确 skip，不影响普通命令。
docs/coordination/archive/qa-report-history.md:1907:  - 若外部自动化长期依赖 demo JSON，可下一轮补 optional `jsonschema` 真实 payload validator；不要扩成新的 schema 工具链、开放式 LLM 或大 UI。
docs/coordination/archive/qa-report-history.md:2372:  - `PYTHONPATH=src python3 -m unittest tests.test_cli.CliDebugOutputTests.test_validation_schema_checker_report_schema_standalone_script_smoke tests.test_cli.CliDebugOutputTests.test_validation_schema_checker_report_schema_standalone_script_forced_skip tests.test_cli.CliDebugOutputTests.test_optional_jsonschema_validates_validation_schema_checker_report_payloads_when_installed`
docs/coordination/archive/qa-report-history.md:2377:  - 当前环境安装了 `jsonschema`，默认入口实际校验 `PASS` / `SKIP` / `FAIL` 三类真实 payload 并通过。
docs/coordination/archive/qa-report-history.md:2394:  - `PYTHONPATH=src python3 -m unittest tests.test_cli.CliDebugOutputTests.test_optional_jsonschema_validates_validation_schema_checker_report_payloads_when_installed`
docs/coordination/archive/qa-report-history.md:2395:  - `PYTHONPATH=src python3 -m unittest tests.test_cli.CliDebugOutputTests.test_validation_schema_checker_report_schema_document_matches_asset tests.test_cli.CliDebugOutputTests.test_validation_schema_runner_report_schema_standalone_script_json_pass_output tests.test_cli.CliDebugOutputTests.test_validation_schema_runner_report_schema_standalone_script_json_skip_output tests.test_cli.CliDebugOutputTests.test_validation_schema_runner_report_schema_standalone_script_json_fail_output tests.test_cli.CliDebugOutputTests.test_optional_jsonschema_validates_validation_schema_checker_report_payloads_when_installed`
docs/coordination/archive/qa-report-history.md:2404:  - `docs/json_schema/validation_schema_checker_report_v1.schema.json` 已通过 optional `jsonschema` validator 真实校验当前 `PASS` / `SKIP` / `FAIL` payload。
docs/coordination/archive/qa-report-history.md:2425:  - 当前该 schema 还没有 optional `jsonschema` validator 真实校验 `PASS` / `SKIP` / `FAIL` payload；如果外部工具长期消费它，下一轮可补这一层。
docs/coordination/archive/qa-report-history.md:2451:  - `PYTHONPATH=src python3 -m unittest tests.test_cli.CliDebugOutputTests.test_validation_schema_runner_report_schema_standalone_script_smoke tests.test_cli.CliDebugOutputTests.test_validation_schema_runner_report_schema_standalone_script_forced_skip tests.test_cli.CliDebugOutputTests.test_optional_jsonschema_validates_validation_schema_runner_report_payloads_when_installed`
docs/coordination/archive/qa-report-history.md:2473:  - `PYTHONPATH=src python3 -m unittest tests.test_cli.CliDebugOutputTests.test_validation_schema_runner_report_schema_standalone_script_smoke tests.test_cli.CliDebugOutputTests.test_validation_schema_runner_report_schema_standalone_script_forced_skip tests.test_cli.CliDebugOutputTests.test_validation_schema_runner_report_schema_standalone_script_json_pass_output tests.test_cli.CliDebugOutputTests.test_validation_schema_runner_report_schema_standalone_script_json_skip_output tests.test_cli.CliDebugOutputTests.test_optional_jsonschema_validates_validation_schema_runner_report_payloads_when_installed`
docs/coordination/archive/qa-report-history.md:2491:  - `PYTHONPATH=src python3 -m unittest tests.test_cli.CliDebugOutputTests.test_validation_schema_runner_report_schema_standalone_script_smoke tests.test_cli.CliDebugOutputTests.test_validation_schema_runner_report_schema_standalone_script_forced_skip tests.test_cli.CliDebugOutputTests.test_optional_jsonschema_validates_validation_schema_runner_report_payloads_when_installed`
docs/coordination/archive/qa-report-history.md:2501:  - 独立入口 `tools/validate_validation_schema_runner_report_schema.py` 已能通过非 unittest 命令真实校验 `PASS` / `SKIP` / `FAIL` payload，缺少 `jsonschema` 时也能明确 skip 并成功退出。
docs/coordination/archive/qa-report-history.md:2508:  - `PYTHONPATH=src python3 -m unittest tests.test_cli.CliDebugOutputTests.test_optional_jsonschema_validates_validation_schema_runner_report_payloads_when_installed`
docs/coordination/archive/qa-report-history.md:2519:  - 独立入口 JSON schema 已通过 optional `jsonschema` validator 真实校验 `PASS` / `SKIP` / `FAIL` payload。
docs/coordination/archive/qa-report-history.md:2539:  - 当前还没有用 optional `jsonschema` validator 真实校验该独立入口的 `PASS` / `SKIP` / `FAIL` payload；如果外部工具长期消费它，下一轮可补这一层。
docs/coordination/archive/qa-report-history.md:2606:  - `PYTHONPATH=src python3 -m unittest tests.test_cli.CliDebugOutputTests.test_validation_script_json_outputs_match_contract_asset tests.test_cli.CliDebugOutputTests.test_validation_report_schema_document_matches_asset tests.test_cli.CliDebugOutputTests.test_optional_jsonschema_validates_validation_report_payloads_when_installed tests.test_cli.CliDebugOutputTests.test_validation_report_schema_standalone_script_smoke`
docs/coordination/archive/qa-report-history.md:2627:  - `PYTHONPATH=src python3 -m unittest tests.test_cli.CliDebugOutputTests.test_validation_report_schema_standalone_script_smoke tests.test_cli.CliDebugOutputTests.test_validation_report_schema_standalone_script_forced_skip tests.test_cli.CliDebugOutputTests.test_optional_jsonschema_validates_validation_report_payloads_when_installed`
docs/coordination/archive/qa-report-history.md:2642:  - `PYTHONPATH=src python3 -m unittest tests.test_cli.CliDebugOutputTests.test_optional_jsonschema_validates_validation_report_payloads_when_installed`
docs/coordination/archive/qa-report-history.md:2867:  - 当前 smoke test 在本环境里实际覆盖了 `PASS` 分支，但 `SKIP` 分支仍依赖未来“未安装 `jsonschema`”的真实环境触发，自动化覆盖还不够可控。
docs/coordination/archive/qa-report-history.md:2876:  - `PYTHONPATH=src python3 -m unittest tests.test_cli.CliDebugOutputTests.test_optional_jsonschema_validates_contract_payloads_when_installed`
docs/coordination/archive/qa-report-history.md:2885:  - 缺少 `jsonschema` 时脚本按设计打印 `SKIP` 并成功退出，这是预期边界，但还没有自动化覆盖脚本级 `SKIP` / `PASS` 输出语义。
docs/coordination/archive/qa-report-history.md:2892:  - `PYTHONPATH=src python3 -m unittest tests.test_cli.CliDebugOutputTests.test_optional_jsonschema_validates_contract_payloads_when_installed`
docs/coordination/archive/qa-report-history.md:2900:  - 当前环境已安装 `jsonschema`，可选 validation 定向测试实际执行并通过；若其他环境未安装，应按测试设计明确 skip。
docs/freeze/FREEZE-RULING-2026-04-15.md:14:- P17：故障注入 UI + backend overrides 桥接 + 9 pytest 覆盖（+9 tests → 439 total）
docs/coordination/archive/dev-handoff-history.md:4430:  - 缺少 `jsonschema` 或设置 `WELL_HARNESS_FORCE_JSONSCHEMA_MISSING=1` 时，JSON 输出稳定为 `status=skip`、`results=[]`、`reason=<optional dependency message>`。
docs/coordination/archive/dev-handoff-history.md:4448:- `PYTHONPATH=src python3 -m unittest tests.test_demo.DemoIntentLayerTests.test_demo_answer_schema_standalone_script_smoke tests.test_demo.DemoIntentLayerTests.test_demo_answer_schema_standalone_script_forced_skip tests.test_demo.DemoIntentLayerTests.test_demo_answer_schema_standalone_script_json_pass_output tests.test_demo.DemoIntentLayerTests.test_demo_answer_schema_standalone_script_json_forced_skip_output tests.test_demo.DemoIntentLayerTests.test_optional_jsonschema_validates_demo_json_payloads_when_installed`
docs/coordination/archive/dev-handoff-history.md:4497:  - 安装 `jsonschema` 时使用 `Draft202012Validator.check_schema(...)` 与 validator 校验真实 payload。
docs/coordination/archive/dev-handoff-history.md:4498:  - 缺少 `jsonschema` 或设置 `WELL_HARNESS_FORCE_JSONSCHEMA_MISSING=1` 时打印明确 `SKIP` 并以 0 退出。
docs/coordination/archive/dev-handoff-history.md:4508:  - 说明 `jsonschema` 是可选依赖；普通 demo / run 命令不依赖它。
docs/coordination/archive/dev-handoff-history.md:4515:- `PYTHONPATH=src python3 -m unittest tests.test_demo.DemoIntentLayerTests.test_demo_answer_schema_standalone_script_smoke tests.test_demo.DemoIntentLayerTests.test_demo_answer_schema_standalone_script_forced_skip tests.test_demo.DemoIntentLayerTests.test_optional_jsonschema_validates_demo_json_payloads_when_installed`

exec
/bin/zsh -lc "rg -n \"pip install|\\[dev\\]|pytest|numpy|jsonschema\" .github/workflows .github" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
.github/workflows/rehearsal-smoke.yml:44:          python -m pip install --upgrade pip
.github/workflows/rehearsal-smoke.yml:45:          pip install -e .
.github/workflows/rehearsal-smoke.yml:48:          pip install beautifulsoup4
.github/workflows/rehearsal-smoke.yml:44:          python -m pip install --upgrade pip
.github/workflows/rehearsal-smoke.yml:45:          pip install -e .
.github/workflows/rehearsal-smoke.yml:48:          pip install beautifulsoup4
.github/workflows/gsd-automation.yml:53:        # Install all [dev] extras from pyproject.toml so CI matches local runs.
.github/workflows/gsd-automation.yml:54:        # Previously only installed jsonschema + pytest, missing pytest-subtests / numpy / pyyaml.
.github/workflows/gsd-automation.yml:55:        run: pip install -e '.[dev]'
.github/workflows/gsd-automation.yml:53:        # Install all [dev] extras from pyproject.toml so CI matches local runs.
.github/workflows/gsd-automation.yml:54:        # Previously only installed jsonschema + pytest, missing pytest-subtests / numpy / pyyaml.
.github/workflows/gsd-automation.yml:55:        run: pip install -e '.[dev]'

exec
/bin/zsh -lc "rg -n \"workbench wow|wow starter|starter cards|E11-05|runWowScenario|installWowStarters\" -g '*.md' .planning README.md docs" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
.planning/phases/E11-workbench-engineer-first-ux/E11-05-SURFACE-INVENTORY.md:1:# E11-05 Surface Inventory — wow_a/b/c canonical-scenario starter cards
.planning/phases/E11-workbench-engineer-first-ux/E11-05-SURFACE-INVENTORY.md:5:> Records every user-facing string introduced by E11-05 and classifies each per the [ANCHORED/REWRITE/DELETE] taxonomy so the Tier-A vs Tier-B routing decision is auditable.
.planning/phases/E11-workbench-engineer-first-ux/E11-05-SURFACE-INVENTORY.md:23:| 13 | `workbench_start.html` line ~69: "wow_a/b/c 起手卡片是 E11-05 范围，本期暂未上线" → "wow_a/b/c 起手卡片已上线（E11-05），见 /workbench 顶部「起手卡」" | [REWRITE] | `workbench_start.html:69` | Now that E11-05 ships, the placeholder is updated to a positive claim. |
.planning/phases/E11-workbench-engineer-first-ux/E11-05-SURFACE-INVENTORY.md:24:| 14 | `workbench_start.html` line ~108: "wow_a/b/c 目前只在 tests/e2e/test_wow_a_causal_chain.py 里有，没有 UI 走读 surface" → "wow_a/b/c 起手卡 已在 /workbench 顶部上线（E11-05）…" | [REWRITE] | `workbench_start.html:107-108` | Removes the negative claim that no UI走读 surface exists. |
...
.planning/phases/E11-workbench-engineer-first-ux/E11-05-SURFACE-INVENTORY.md:38:Both thresholds are met: the 3 [REWRITE] lines on `workbench_start.html` are doc-truth corrections (placeholder copy that previously claimed E11-05 wasn't shipped). Per the rule's spirit — protect against stale copy reaching production — Tier-A is the conservative routing here.
.planning/phases/E11-workbench-engineer-first-ux/E11-05-SURFACE-INVENTORY.md:40:> **Action: dispatch all 5 personas (P1–P5) for E11-05.**
.planning/phases/E11-workbench-engineer-first-ux/E11-05-SURFACE-INVENTORY.md:47:- `src/well_harness/static/workbench.js` (NEW WOW_SCENARIOS const + runWowScenario + installWowStarters + 1 hook line in DOMContentLoaded)
.planning/phases/E11-workbench-engineer-first-ux/E11-05-SURFACE-INVENTORY.md:48:- `src/well_harness/static/workbench_start.html` (3 [REWRITE] lines documenting that E11-05 has shipped)
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:16:You are Codex GPT-5.4 acting as **Persona P2 — Senior FCS Engineer** (Tier-A 5-persona pipeline, E11-05 sub-phase).
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:18:# Shared context for E11-05 review (all 5 personas)
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:25:## What E11-05 ships
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:27:Per `E11-00-PLAN.md` row E11-05: top-of-/workbench one-click starter cards for the three demo wow scenarios.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:32:- `src/well_harness/static/workbench.js` — NEW `WOW_SCENARIOS` const, `runWowScenario(wowId)`, `installWowStarters()`, plus 1 hook line in DOMContentLoaded.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:33:- `src/well_harness/static/workbench_start.html` — 3 [REWRITE] lines updating stale claims that E11-05 hadn't shipped.
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:36:- `.planning/phases/E11-workbench-engineer-first-ux/PERSONA-ROTATION-STATE.md` — appended E11-05 = Tier-A.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:86:Sign as: **P2 — Senior FCS Engineer (Tier-A, E11-05)**
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:342:a02729a (HEAD -> feat/e11-05-wow-starter-cards-20260425) phase(E11-05): wow_a/b/c canonical-scenario starter cards on /workbench
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:351:?? .planning/phases/E11-workbench-engineer-first-ux/persona-E11-05-shared-context.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:352:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:353:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:354:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:355:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:356:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:357:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:358:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:359:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:360:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:361:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-prompt.txt
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:433:tests/test_workbench_wow_starters.py:1:"""E11-05 — wow_a/b/c canonical-scenario starter cards regression lock.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:516:src/well_harness/static/workbench_start.html:69:        <li>wow_a/b/c 起手卡片已上线（E11-05），见 <code>/workbench</code> 顶部「起手卡」</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:517:src/well_harness/static/workbench_start.html:108:        wow_a/b/c 起手卡 已在 <code>/workbench</code> 顶部上线（E11-05），可以一键走读
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:518:src/well_harness/static/workbench_start.html:114:        <li>无-chrome demo mode 进入 E11-08 范围（wow_a 走读 已 E11-05 完成）</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:578:src/well_harness/static/workbench.js:3792:// E11-05 (2026-04-25): wow_a/b/c canonical-scenario starter cards.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:621:    30	      标记落地是为了 E11-05 / E11-08 / E11-11 这几期能基于它做角色化裁剪。
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:660:    69	        <li>wow_a/b/c 起手卡片已上线（E11-05），见 <code>/workbench</code> 顶部「起手卡」</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:699:   108	        wow_a/b/c 起手卡 已在 <code>/workbench</code> 顶部上线（E11-05），可以一键走读
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:705:   114	        <li>无-chrome demo mode 进入 E11-08 范围（wow_a 走读 已 E11-05 完成）</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:854:    54	        aria-label="Canonical demo scenarios — one-click starter cards"
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1124:     1	"""E11-05 — wow_a/b/c canonical-scenario starter cards regression lock.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1126:     3	Locks the contract for the top-of-/workbench wow starter cards so future
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1128:     5	entrypoint. Per E11-00-PLAN row E11-05.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1131:     8	  1. /workbench static HTML carries the three starter cards (one per
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1200:    77	# ─── 1. Static HTML carries all three starter cards ──────────────────
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1237:   114	def test_workbench_js_installWowStarters_wired_to_dom() -> None:
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1239:   116	    assert "function installWowStarters" in js
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1241:   118	    assert re.search(r"installWowStarters\s*\(\s*\)", js) is not None
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1294:   171	    """Live-served /workbench page includes the wow starters section."""
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1305:     1	# E11-05 Surface Inventory — wow_a/b/c canonical-scenario starter cards
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1309:     5	> Records every user-facing string introduced by E11-05 and classifies each per the [ANCHORED/REWRITE/DELETE] taxonomy so the Tier-A vs Tier-B routing decision is auditable.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1327:    23	| 13 | `workbench_start.html` line ~69: "wow_a/b/c 起手卡片是 E11-05 范围，本期暂未上线" → "wow_a/b/c 起手卡片已上线（E11-05），见 /workbench 顶部「起手卡」" | [REWRITE] | `workbench_start.html:69` | Now that E11-05 ships, the placeholder is updated to a positive claim. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1328:    24	| 14 | `workbench_start.html` line ~108: "wow_a/b/c 目前只在 tests/e2e/test_wow_a_causal_chain.py 里有，没有 UI 走读 surface" → "wow_a/b/c 起手卡 已在 /workbench 顶部上线（E11-05）…" | [REWRITE] | `workbench_start.html:107-108` | Removes the negative claim that no UI走读 surface exists. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1329:    25	| 15 | `workbench_start.html` line ~113: "无-chrome demo mode + UI wow_a 走读 进入 E11-05/08 范围" → "无-chrome demo mode 进入 E11-08 范围（wow_a 走读 已 E11-05 完成）" | [REWRITE] | `workbench_start.html:113` | Removes the implicit claim that wow_a走读 is still pending; demarcates remaining E11-08 scope. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1342:    38	Both thresholds are met: the 3 [REWRITE] lines on `workbench_start.html` are doc-truth corrections (placeholder copy that previously claimed E11-05 wasn't shipped). Per the rule's spirit — protect against stale copy reaching production — Tier-A is the conservative routing here.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1344:    40	> **Action: dispatch all 5 personas (P1–P5) for E11-05.**
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1351:    47	- `src/well_harness/static/workbench.js` (NEW WOW_SCENARIOS const + runWowScenario + installWowStarters + 1 hook line in DOMContentLoaded)
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1352:    48	- `src/well_harness/static/workbench_start.html` (3 [REWRITE] lines documenting that E11-05 has shipped)
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:1368:    13	E11-05: Tier-A (≥10 copy_diff_lines AND ≥3 [REWRITE]: 3 workbench_start.html corrections + 12 ANCHORED card copy lines). All 5 personas dispatched. Rotation pointer unchanged (Tier-A does not consume a Tier-B slot).
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:2003:   107	/* E11-05 (2026-04-25): wow_a/b/c canonical-scenario starter cards.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:6646:  3792	// E11-05 (2026-04-25): wow_a/b/c canonical-scenario starter cards.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:6694:  3840	async function runWowScenario(wowId) {
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:6742:  3888	function installWowStarters() {
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:6750:  3896	        void runWowScenario(wowId);
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:6760:  3906	  installWowStarters();
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8417:+# E11-05 Surface Inventory — wow_a/b/c canonical-scenario starter cards
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8421:+> Records every user-facing string introduced by E11-05 and classifies each per the [ANCHORED/REWRITE/DELETE] taxonomy so the Tier-A vs Tier-B routing decision is auditable.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8439:+| 13 | `workbench_start.html` line ~69: "wow_a/b/c 起手卡片是 E11-05 范围，本期暂未上线" → "wow_a/b/c 起手卡片已上线（E11-05），见 /workbench 顶部「起手卡」" | [REWRITE] | `workbench_start.html:69` | Now that E11-05 ships, the placeholder is updated to a positive claim. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8440:+| 14 | `workbench_start.html` line ~108: "wow_a/b/c 目前只在 tests/e2e/test_wow_a_causal_chain.py 里有，没有 UI 走读 surface" → "wow_a/b/c 起手卡 已在 /workbench 顶部上线（E11-05）…" | [REWRITE] | `workbench_start.html:107-108` | Removes the negative claim that no UI走读 surface exists. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8441:+| 15 | `workbench_start.html` line ~113: "无-chrome demo mode + UI wow_a 走读 进入 E11-05/08 范围" → "无-chrome demo mode 进入 E11-08 范围（wow_a 走读 已 E11-05 完成）" | [REWRITE] | `workbench_start.html:113` | Removes the implicit claim that wow_a走读 is still pending; demarcates remaining E11-08 scope. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8454:+Both thresholds are met: the 3 [REWRITE] lines on `workbench_start.html` are doc-truth corrections (placeholder copy that previously claimed E11-05 wasn't shipped). Per the rule's spirit — protect against stale copy reaching production — Tier-A is the conservative routing here.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8456:+> **Action: dispatch all 5 personas (P1–P5) for E11-05.**
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8463:+- `src/well_harness/static/workbench.js` (NEW WOW_SCENARIOS const + runWowScenario + installWowStarters + 1 hook line in DOMContentLoaded)
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8464:+- `src/well_harness/static/workbench_start.html` (3 [REWRITE] lines documenting that E11-05 has shipped)
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8478:+E11-05: Tier-A (≥10 copy_diff_lines AND ≥3 [REWRITE]: 3 workbench_start.html corrections + 12 ANCHORED card copy lines). All 5 personas dispatched. Rotation pointer unchanged (Tier-A does not consume a Tier-B slot).
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8489:+/* E11-05 (2026-04-25): wow_a/b/c canonical-scenario starter cards.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8639:+        aria-label="Canonical demo scenarios — one-click starter cards"
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8757:+// E11-05 (2026-04-25): wow_a/b/c canonical-scenario starter cards.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8805:+async function runWowScenario(wowId) {
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8853:+function installWowStarters() {
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8861:+        void runWowScenario(wowId);
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8871:+  installWowStarters();
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8887:-        <li>wow_a/b/c 起手卡片是 E11-05 范围，本期暂未上线</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8888:+        <li>wow_a/b/c 起手卡片已上线（E11-05），见 <code>/workbench</code> 顶部「起手卡」</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8901:+        wow_a/b/c 起手卡 已在 <code>/workbench</code> 顶部上线（E11-05），可以一键走读
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8907:-        <li>无-chrome demo mode + UI wow_a 走读 进入 E11-05/08 范围</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8908:+        <li>无-chrome demo mode 进入 E11-08 范围（wow_a 走读 已 E11-05 完成）</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8920:+"""E11-05 — wow_a/b/c canonical-scenario starter cards regression lock.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8922:+Locks the contract for the top-of-/workbench wow starter cards so future
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8924:+entrypoint. Per E11-00-PLAN row E11-05.
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8927:+  1. /workbench static HTML carries the three starter cards (one per
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:8996:+# ─── 1. Static HTML carries all three starter cards ──────────────────
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:9033:+def test_workbench_js_installWowStarters_wired_to_dom() -> None:
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:9035:+    assert "function installWowStarters" in js
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:9037:+    assert re.search(r"installWowStarters\s*\(\s*\)", js) is not None
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md:9090:+    """Live-served /workbench page includes the wow starters section."""
.planning/phases/E11-workbench-engineer-first-ux/E11-00-PLAN.md:98:| **E11-05** | Canonical scenarios 起手卡 — wow_a/b/c 在顶部以 starter card 出现，一键 POST `/api/lever-snapshot` 预填 BEAT_DEEP_PAYLOAD 等 | E11-01 | 不 |
.planning/phases/E11-workbench-engineer-first-ux/E11-00-PLAN.md:128:E11-09 → E11-13/14 → E11-05 → E11-03 → E11-04 → E11-06
.planning/phases/E11-workbench-engineer-first-ux/E11-00-PLAN.md:135:3. **E11-05 wow 起手卡片** — 兜 P3 demo presenter 的 BLOCKER #1（presenter 找不到 wow 入口）。
.planning/phases/E11-workbench-engineer-first-ux/E11-00-PLAN.md:276:| E11-05 | code (JS) | ~150 | 1h | YES (UI 交互模式变更) |
.planning/phases/governance-bundle-2/codex-r2-output.md:983:   274	| E11-05 | code (JS) | ~150 | 1h | YES (UI 交互模式变更) |
.planning/phases/governance-bundle-2/codex-r4-output.md:544: E11-09 → E11-13/14 → E11-05 → E11-03 → E11-04 → E11-06
.planning/phases/governance-bundle-2/codex-r4-output.md:551: 3. **E11-05 wow 起手卡片** — 兜 P3 demo presenter 的 BLOCKER #1（presenter 找不到 wow 入口）。
.planning/phases/governance-bundle-2/codex-r3-output.md:578:   277	| E11-05 | code (JS) | ~150 | 1h | YES (UI 交互模式变更) |
.planning/phases/governance-bundle-2/codex-r3-output.md:814:@@ -145,198 +145,201 @@ E11-09 → E11-13/14 → E11-05 → E11-03 → E11-04 → E11-06
.planning/phases/governance-bundle-2/codex-r3-output.md:955: | E11-05 | code (JS) | ~150 | 1h | YES (UI 交互模式变更) |
.planning/phases/governance-bundle-2/codex-r5-output.md:377:@@ -155,17 +155,17 @@ E11-09 → E11-13/14 → E11-05 → E11-03 → E11-04 → E11-06
.planning/phases/governance-bundle-2/codex-r5-output.md:698:    98	| **E11-05** | Canonical scenarios 起手卡 — wow_a/b/c 在顶部以 starter card 出现，一键 POST `/api/lever-snapshot` 预填 BEAT_DEEP_PAYLOAD 等 | E11-01 | 不 |
.planning/phases/governance-bundle-2/codex-r5-output.md:728:   128	E11-09 → E11-13/14 → E11-05 → E11-03 → E11-04 → E11-06
.planning/phases/governance-bundle-2/codex-r5-output.md:735:   135	3. **E11-05 wow 起手卡片** — 兜 P3 demo presenter 的 BLOCKER #1（presenter 找不到 wow 入口）。
.planning/phases/governance-bundle-2/codex-r5-output.md:876:   276	| E11-05 | code (JS) | ~150 | 1h | YES (UI 交互模式变更) |
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:16:You are Codex GPT-5.4 acting as **Persona P3 — Demo Presenter** (Tier-A 5-persona pipeline, E11-05 sub-phase).
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:18:# Shared context for E11-05 review (all 5 personas)
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:25:## What E11-05 ships
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:27:Per `E11-00-PLAN.md` row E11-05: top-of-/workbench one-click starter cards for the three demo wow scenarios.
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:32:- `src/well_harness/static/workbench.js` — NEW `WOW_SCENARIOS` const, `runWowScenario(wowId)`, `installWowStarters()`, plus 1 hook line in DOMContentLoaded.
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:33:- `src/well_harness/static/workbench_start.html` — 3 [REWRITE] lines updating stale claims that E11-05 hadn't shipped.
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:36:- `.planning/phases/E11-workbench-engineer-first-ux/PERSONA-ROTATION-STATE.md` — appended E11-05 = Tier-A.
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:86:Sign as: **P3 — Demo Presenter (Tier-A, E11-05)**
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:88:Reviewing E11-05 as P3 with a demo-presenter lens. I’m pulling the repo state, the scoped files, and the existing LogicMVP memory so I can check the live-demo flow and the truth-engine red line against the actual branch contents.
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:95:/bin/zsh -lc 'rg -n "LogicMVP|ai-fantui-logicmvp|E11-05|workbench" /Users/Zhuanz/.codex/memories/MEMORY.md' in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:150:?? .planning/phases/E11-workbench-engineer-first-ux/persona-E11-05-shared-context.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:151:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:152:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:153:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:154:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:155:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:156:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:157:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:158:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:159:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:160:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-prompt.txt
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:303:    54	        aria-label="Canonical demo scenarios — one-click starter cards"
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:600:    30	      标记落地是为了 E11-05 / E11-08 / E11-11 这几期能基于它做角色化裁剪。
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:639:    69	        <li>wow_a/b/c 起手卡片已上线（E11-05），见 <code>/workbench</code> 顶部「起手卡」</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:678:   108	        wow_a/b/c 起手卡 已在 <code>/workbench</code> 顶部上线（E11-05），可以一键走读
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:684:   114	        <li>无-chrome demo mode 进入 E11-08 范围（wow_a 走读 已 E11-05 完成）</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:782:     1	"""E11-05 — wow_a/b/c canonical-scenario starter cards regression lock.
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:784:     3	Locks the contract for the top-of-/workbench wow starter cards so future
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:786:     5	entrypoint. Per E11-00-PLAN row E11-05.
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:789:     8	  1. /workbench static HTML carries the three starter cards (one per
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:858:    77	# ─── 1. Static HTML carries all three starter cards ──────────────────
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:895:   114	def test_workbench_js_installWowStarters_wired_to_dom() -> None:
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:897:   116	    assert "function installWowStarters" in js
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:899:   118	    assert re.search(r"installWowStarters\s*\(\s*\)", js) is not None
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:952:   171	    """Live-served /workbench page includes the wow starters section."""
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:963:     1	# E11-05 Surface Inventory — wow_a/b/c canonical-scenario starter cards
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:967:     5	> Records every user-facing string introduced by E11-05 and classifies each per the [ANCHORED/REWRITE/DELETE] taxonomy so the Tier-A vs Tier-B routing decision is auditable.
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:985:    23	| 13 | `workbench_start.html` line ~69: "wow_a/b/c 起手卡片是 E11-05 范围，本期暂未上线" → "wow_a/b/c 起手卡片已上线（E11-05），见 /workbench 顶部「起手卡」" | [REWRITE] | `workbench_start.html:69` | Now that E11-05 ships, the placeholder is updated to a positive claim. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:986:    24	| 14 | `workbench_start.html` line ~108: "wow_a/b/c 目前只在 tests/e2e/test_wow_a_causal_chain.py 里有，没有 UI 走读 surface" → "wow_a/b/c 起手卡 已在 /workbench 顶部上线（E11-05）…" | [REWRITE] | `workbench_start.html:107-108` | Removes the negative claim that no UI走读 surface exists. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:987:    25	| 15 | `workbench_start.html` line ~113: "无-chrome demo mode + UI wow_a 走读 进入 E11-05/08 范围" → "无-chrome demo mode 进入 E11-08 范围（wow_a 走读 已 E11-05 完成）" | [REWRITE] | `workbench_start.html:113` | Removes the implicit claim that wow_a走读 is still pending; demarcates remaining E11-08 scope. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:1000:    38	Both thresholds are met: the 3 [REWRITE] lines on `workbench_start.html` are doc-truth corrections (placeholder copy that previously claimed E11-05 wasn't shipped). Per the rule's spirit — protect against stale copy reaching production — Tier-A is the conservative routing here.
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:1002:    40	> **Action: dispatch all 5 personas (P1–P5) for E11-05.**
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:1009:    47	- `src/well_harness/static/workbench.js` (NEW WOW_SCENARIOS const + runWowScenario + installWowStarters + 1 hook line in DOMContentLoaded)
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:1010:    48	- `src/well_harness/static/workbench_start.html` (3 [REWRITE] lines documenting that E11-05 has shipped)
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:1028:    13	E11-05: Tier-A (≥10 copy_diff_lines AND ≥3 [REWRITE]: 3 workbench_start.html corrections + 12 ANCHORED card copy lines). All 5 personas dispatched. Rotation pointer unchanged (Tier-A does not consume a Tier-B slot).
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:1141:   107	/* E11-05 (2026-04-25): wow_a/b/c canonical-scenario starter cards.
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:4235:The JS file is much larger than the E11-05 slice, so I’m finishing the full-file read in chunks and then narrowing back to the new wow-card path with live requests. After that I’ll have enough to call whether the cards actually help a presenter on stage or just add another engineering surface.
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:6862:  3792	// E11-05 (2026-04-25): wow_a/b/c canonical-scenario starter cards.
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:6910:  3840	async function runWowScenario(wowId) {
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:6958:  3888	function installWowStarters() {
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:6966:  3896	        void runWowScenario(wowId);
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:6976:  3906	  installWowStarters();
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:7005:/bin/zsh -lc "rg -n \"WOW_SCENARIOS|runWowScenario|installWowStarters|data-wow|summarize\\(|DOMContentLoaded|lever-snapshot|monte-carlo/run|diagnosis/run\" src/well_harness/static/workbench.js src/well_harness/static/workbench.css src/well_harness/static/workbench.html src/well_harness/static/workbench_start.html tests/test_workbench_wow_starters.py" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:7019:tests/test_workbench_wow_starters.py:114:def test_workbench_js_installWowStarters_wired_to_dom() -> None:
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:7020:tests/test_workbench_wow_starters.py:116:    assert "function installWowStarters" in js
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:7022:tests/test_workbench_wow_starters.py:118:    assert re.search(r"installWowStarters\s*\(\s*\)", js) is not None
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:7053:src/well_harness/static/workbench.js:3840:async function runWowScenario(wowId) {
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:7062:src/well_harness/static/workbench.js:3888:function installWowStarters() {
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:7066:src/well_harness/static/workbench.js:3896:        void runWowScenario(wowId);
.planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md:7068:src/well_harness/static/workbench.js:3906:  installWowStarters();
.planning/phases/governance-bundle-2/codex-r6-output.md:573:    98	| **E11-05** | Canonical scenarios 起手卡 — wow_a/b/c 在顶部以 starter card 出现，一键 POST `/api/lever-snapshot` 预填 BEAT_DEEP_PAYLOAD 等 | E11-01 | 不 |
.planning/phases/governance-bundle-2/codex-r6-output.md:603:   128	E11-09 → E11-13/14 → E11-05 → E11-03 → E11-04 → E11-06
.planning/phases/governance-bundle-2/codex-r6-output.md:610:   135	3. **E11-05 wow 起手卡片** — 兜 P3 demo presenter 的 BLOCKER #1（presenter 找不到 wow 入口）。
.planning/phases/governance-bundle-2/codex-r6-output.md:751:   276	| E11-05 | code (JS) | ~150 | 1h | YES (UI 交互模式变更) |
.planning/phases/governance-bundle-2/codex-r6-output.md:1063:@@ -160,7 +160,7 @@ E11-09 → E11-13/14 → E11-05 → E11-03 → E11-04 → E11-06
.planning/phases/governance-bundle-2/codex-r3-retry-output.md:1839:    98	| **E11-05** | Canonical scenarios 起手卡 — wow_a/b/c 在顶部以 starter card 出现，一键 POST `/api/lever-snapshot` 预填 BEAT_DEEP_PAYLOAD 等 | E11-01 | 不 |
.planning/phases/governance-bundle-2/codex-r3-retry-output.md:1869:   128	E11-09 → E11-13/14 → E11-05 → E11-03 → E11-04 → E11-06
.planning/phases/governance-bundle-2/codex-r3-retry-output.md:1876:   135	3. **E11-05 wow 起手卡片** — 兜 P3 demo presenter 的 BLOCKER #1（presenter 找不到 wow 入口）。
.planning/phases/governance-bundle-2/codex-r3-retry-output.md:2018:   277	| E11-05 | code (JS) | ~150 | 1h | YES (UI 交互模式变更) |
.planning/phases/E11-workbench-engineer-first-ux/persona-P2-output.md:3414:    98	| **E11-05** | Canonical scenarios 起手卡 — wow_a/b/c 在顶部以 starter card 出现，一键 POST `/api/lever-snapshot` 预填 BEAT_DEEP_PAYLOAD 等 | E11-01 | 不 |
...
.planning/phases/E11-workbench-engineer-first-ux/E11-01-BASELINE-PERSONA-REVIEW.md:128:**E11 path**: E11-05 wow scenario starter cards — already in plan, escalate priority.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:16:You are Codex GPT-5.4 acting as **Persona P1 — Junior FCS Engineer** (Tier-A 5-persona pipeline, E11-05 sub-phase).
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:18:# Shared context for E11-05 review (all 5 personas)
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:25:## What E11-05 ships
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:27:Per `E11-00-PLAN.md` row E11-05: top-of-/workbench one-click starter cards for the three demo wow scenarios.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:32:- `src/well_harness/static/workbench.js` — NEW `WOW_SCENARIOS` const, `runWowScenario(wowId)`, `installWowStarters()`, plus 1 hook line in DOMContentLoaded.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:33:- `src/well_harness/static/workbench_start.html` — 3 [REWRITE] lines updating stale claims that E11-05 hadn't shipped.
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:36:- `.planning/phases/E11-workbench-engineer-first-ux/PERSONA-ROTATION-STATE.md` — appended E11-05 = Tier-A.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:86:Sign as: **P1 — Junior FCS Engineer (Tier-A, E11-05)**
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:427:/bin/zsh -lc 'rg -n "LogicMVP|ai-fantui-logicmvp|E11-05|wow starter|workbench wow" /Users/Zhuanz/.codex/memories/MEMORY.md' in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:523:  • Run targeted validation for wow starter tests and, if useful, a live probe
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:529:?? .planning/phases/E11-workbench-engineer-first-ux/persona-E11-05-shared-context.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:530:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:531:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:532:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:533:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:534:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:535:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:536:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:537:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:538:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:539:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-prompt.txt
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:589:+# E11-05 Surface Inventory — wow_a/b/c canonical-scenario starter cards
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:593:+> Records every user-facing string introduced by E11-05 and classifies each per the [ANCHORED/REWRITE/DELETE] taxonomy so the Tier-A vs Tier-B routing decision is auditable.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:611:+| 13 | `workbench_start.html` line ~69: "wow_a/b/c 起手卡片是 E11-05 范围，本期暂未上线" → "wow_a/b/c 起手卡片已上线（E11-05），见 /workbench 顶部「起手卡」" | [REWRITE] | `workbench_start.html:69` | Now that E11-05 ships, the placeholder is updated to a positive claim. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:612:+| 14 | `workbench_start.html` line ~108: "wow_a/b/c 目前只在 tests/e2e/test_wow_a_causal_chain.py 里有，没有 UI 走读 surface" → "wow_a/b/c 起手卡 已在 /workbench 顶部上线（E11-05）…" | [REWRITE] | `workbench_start.html:107-108` | Removes the negative claim that no UI走读 surface exists. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:613:+| 15 | `workbench_start.html` line ~113: "无-chrome demo mode + UI wow_a 走读 进入 E11-05/08 范围" → "无-chrome demo mode 进入 E11-08 范围（wow_a 走读 已 E11-05 完成）" | [REWRITE] | `workbench_start.html:113` | Removes the implicit claim that wow_a走读 is still pending; demarcates remaining E11-08 scope. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:626:+Both thresholds are met: the 3 [REWRITE] lines on `workbench_start.html` are doc-truth corrections (placeholder copy that previously claimed E11-05 wasn't shipped). Per the rule's spirit — protect against stale copy reaching production — Tier-A is the conservative routing here.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:628:+> **Action: dispatch all 5 personas (P1–P5) for E11-05.**
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:635:+- `src/well_harness/static/workbench.js` (NEW WOW_SCENARIOS const + runWowScenario + installWowStarters + 1 hook line in DOMContentLoaded)
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:636:+- `src/well_harness/static/workbench_start.html` (3 [REWRITE] lines documenting that E11-05 has shipped)
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:657:+E11-05: Tier-A (≥10 copy_diff_lines AND ≥3 [REWRITE]: 3 workbench_start.html corrections + 12 ANCHORED card copy lines). All 5 personas dispatched. Rotation pointer unchanged (Tier-A does not consume a Tier-B slot).
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:743:+/* E11-05 (2026-04-25): wow_a/b/c canonical-scenario starter cards.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1013:+        aria-label="Canonical demo scenarios — one-click starter cards"
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1281:+// E11-05 (2026-04-25): wow_a/b/c canonical-scenario starter cards.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1329:+async function runWowScenario(wowId) {
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1377:+function installWowStarters() {
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1385:+        void runWowScenario(wowId);
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1395:+  installWowStarters();
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1456:       标记落地是为了 E11-05 / E11-08 / E11-11 这几期能基于它做角色化裁剪。
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1495:-        <li>wow_a/b/c 起手卡片是 E11-05 范围，本期暂未上线</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1496:+        <li>wow_a/b/c 起手卡片已上线（E11-05），见 <code>/workbench</code> 顶部「起手卡」</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1536:+        wow_a/b/c 起手卡 已在 <code>/workbench</code> 顶部上线（E11-05），可以一键走读
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1542:-        <li>无-chrome demo mode + UI wow_a 走读 进入 E11-05/08 范围</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1543:+        <li>无-chrome demo mode 进入 E11-08 范围（wow_a 走读 已 E11-05 完成）</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1630:+"""E11-05 — wow_a/b/c canonical-scenario starter cards regression lock.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1632:+Locks the contract for the top-of-/workbench wow starter cards so future
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1634:+entrypoint. Per E11-00-PLAN row E11-05.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1637:+  1. /workbench static HTML carries the three starter cards (one per
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1706:+# ─── 1. Static HTML carries all three starter cards ──────────────────
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1743:+def test_workbench_js_installWowStarters_wired_to_dom() -> None:
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1745:+    assert "function installWowStarters" in js
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1747:+    assert re.search(r"installWowStarters\s*\(\s*\)", js) is not None
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1800:+    """Live-served /workbench page includes the wow starters section."""
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:1969:    54	        aria-label="Canonical demo scenarios — one-click starter cards"
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2169:    30	      标记落地是为了 E11-05 / E11-08 / E11-11 这几期能基于它做角色化裁剪。
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2208:    69	        <li>wow_a/b/c 起手卡片已上线（E11-05），见 <code>/workbench</code> 顶部「起手卡」</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2247:   108	        wow_a/b/c 起手卡 已在 <code>/workbench</code> 顶部上线（E11-05），可以一键走读
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2253:   114	        <li>无-chrome demo mode 进入 E11-08 范围（wow_a 走读 已 E11-05 完成）</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2351:     1	"""E11-05 — wow_a/b/c canonical-scenario starter cards regression lock.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2353:     3	Locks the contract for the top-of-/workbench wow starter cards so future
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2355:     5	entrypoint. Per E11-00-PLAN row E11-05.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2358:     8	  1. /workbench static HTML carries the three starter cards (one per
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2427:    77	# ─── 1. Static HTML carries all three starter cards ──────────────────
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2464:   114	def test_workbench_js_installWowStarters_wired_to_dom() -> None:
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2466:   116	    assert "function installWowStarters" in js
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2468:   118	    assert re.search(r"installWowStarters\s*\(\s*\)", js) is not None
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2521:   171	    """Live-served /workbench page includes the wow starters section."""
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2579:/bin/zsh -lc "rg -n \"workbench-wow|WOW_SCENARIOS|runWowScenario|installWowStarters|DOMContentLoaded|installFeedbackModeAffordance|syncTrustBannerForMode|fetch\\(|workbench-system-select|sessionStorage|workbench-packet-json\" src/well_harness/static/workbench.js" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2609:3840:async function runWowScenario(wowId) {
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2614:3888:function installWowStarters() {
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2617:3896:        void runWowScenario(wowId);
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2620:3906:  installWowStarters();
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2641:    13	E11-05: Tier-A (≥10 copy_diff_lines AND ≥3 [REWRITE]: 3 workbench_start.html corrections + 12 ANCHORED card copy lines). All 5 personas dispatched. Rotation pointer unchanged (Tier-A does not consume a Tier-B slot).
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2644:     1	# E11-05 Surface Inventory — wow_a/b/c canonical-scenario starter cards
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2648:     5	> Records every user-facing string introduced by E11-05 and classifies each per the [ANCHORED/REWRITE/DELETE] taxonomy so the Tier-A vs Tier-B routing decision is auditable.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2666:    23	| 13 | `workbench_start.html` line ~69: "wow_a/b/c 起手卡片是 E11-05 范围，本期暂未上线" → "wow_a/b/c 起手卡片已上线（E11-05），见 /workbench 顶部「起手卡」" | [REWRITE] | `workbench_start.html:69` | Now that E11-05 ships, the placeholder is updated to a positive claim. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2667:    24	| 14 | `workbench_start.html` line ~108: "wow_a/b/c 目前只在 tests/e2e/test_wow_a_causal_chain.py 里有，没有 UI 走读 surface" → "wow_a/b/c 起手卡 已在 /workbench 顶部上线（E11-05）…" | [REWRITE] | `workbench_start.html:107-108` | Removes the negative claim that no UI走读 surface exists. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2668:    25	| 15 | `workbench_start.html` line ~113: "无-chrome demo mode + UI wow_a 走读 进入 E11-05/08 范围" → "无-chrome demo mode 进入 E11-08 范围（wow_a 走读 已 E11-05 完成）" | [REWRITE] | `workbench_start.html:113` | Removes the implicit claim that wow_a走读 is still pending; demarcates remaining E11-08 scope. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2681:    38	Both thresholds are met: the 3 [REWRITE] lines on `workbench_start.html` are doc-truth corrections (placeholder copy that previously claimed E11-05 wasn't shipped). Per the rule's spirit — protect against stale copy reaching production — Tier-A is the conservative routing here.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2683:    40	> **Action: dispatch all 5 personas (P1–P5) for E11-05.**
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2690:    47	- `src/well_harness/static/workbench.js` (NEW WOW_SCENARIOS const + runWowScenario + installWowStarters + 1 hook line in DOMContentLoaded)
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2691:    48	- `src/well_harness/static/workbench_start.html` (3 [REWRITE] lines documenting that E11-05 has shipped)
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:2807:   107	/* E11-05 (2026-04-25): wow_a/b/c canonical-scenario starter cards.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:7992:  3792	// E11-05 (2026-04-25): wow_a/b/c canonical-scenario starter cards.
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:8040:  3840	async function runWowScenario(wowId) {
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:8088:  3888	function installWowStarters() {
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:8096:  3896	        void runWowScenario(wowId);
.planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md:8106:  3906	  installWowStarters();
.planning/phases/E11-workbench-engineer-first-ux/E11-02-SURFACE-INVENTORY.md:33:| 7  | workbench_start.html:69 | "wow_a/b/c 起手卡片是 E11-05 范围，本期暂未上线" | feature-name (negative) | E11-00-PLAN.md §3 row E11-05 | [REWRITE → planned for E11-05] |
.planning/phases/E11-workbench-engineer-first-ux/E11-02-SURFACE-INVENTORY.md:39:| 13 | workbench_start.html:108 | "无-chrome demo mode + UI wow_a 走读 进入 E11-05/08 范围" | feature-name (negative) | E11-00-PLAN.md §3 rows E11-05,E11-08 | [REWRITE → planned for E11-05/08] |
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:16:You are Codex GPT-5.4 acting as **Persona P4 — V&V Engineer** (Tier-A 5-persona pipeline, E11-05 sub-phase).
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:18:# Shared context for E11-05 review (all 5 personas)
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:25:## What E11-05 ships
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:27:Per `E11-00-PLAN.md` row E11-05: top-of-/workbench one-click starter cards for the three demo wow scenarios.
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:32:- `src/well_harness/static/workbench.js` — NEW `WOW_SCENARIOS` const, `runWowScenario(wowId)`, `installWowStarters()`, plus 1 hook line in DOMContentLoaded.
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:36:- `.planning/phases/E11-workbench-engineer-first-ux/PERSONA-ROTATION-STATE.md` — appended E11-05 = Tier-A.
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:86:Sign as: **P4 — V&V Engineer (Tier-A, E11-05)**
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:90:/bin/zsh -lc 'rg -n "ai-fantui-logicmvp|LogicMVP|E11-05|wow starters|workbench wow" /Users/Zhuanz/.codex/memories/MEMORY.md' in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:321:?? .planning/phases/E11-workbench-engineer-first-ux/persona-E11-05-shared-context.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:322:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:323:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P1-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:324:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:325:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P2-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:326:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:327:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P3-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:328:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:329:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-prompt.txt
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:330:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:331:?? .planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-prompt.txt
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:355:     1	"""E11-05 — wow_a/b/c canonical-scenario starter cards regression lock.
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:357:     3	Locks the contract for the top-of-/workbench wow starter cards so future
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:359:     5	entrypoint. Per E11-00-PLAN row E11-05.
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:362:     8	  1. /workbench static HTML carries the three starter cards (one per
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:431:    77	# ─── 1. Static HTML carries all three starter cards ──────────────────
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:468:   114	def test_workbench_js_installWowStarters_wired_to_dom() -> None:
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:470:   116	    assert "function installWowStarters" in js
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:472:   118	    assert re.search(r"installWowStarters\s*\(\s*\)", js) is not None
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:525:   171	    """Live-served /workbench page includes the wow starters section."""
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:587:    54	        aria-label="Canonical demo scenarios — one-click starter cards"
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:892:    30	      标记落地是为了 E11-05 / E11-08 / E11-11 这几期能基于它做角色化裁剪。
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:970:   108	        wow_a/b/c 起手卡 已在 <code>/workbench</code> 顶部上线（E11-05），可以一键走读
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:976:   114	        <li>无-chrome demo mode 进入 E11-08 范围（wow_a 走读 已 E11-05 完成）</li>
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:1093:     1	# E11-05 Surface Inventory — wow_a/b/c canonical-scenario starter cards
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:1097:     5	> Records every user-facing string introduced by E11-05 and classifies each per the [ANCHORED/REWRITE/DELETE] taxonomy so the Tier-A vs Tier-B routing decision is auditable.
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:1132:    40	> **Action: dispatch all 5 personas (P1–P5) for E11-05.**
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:1139:    47	- `src/well_harness/static/workbench.js` (NEW WOW_SCENARIOS const + runWowScenario + installWowStarters + 1 hook line in DOMContentLoaded)
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:1658:   107	/* E11-05 (2026-04-25): wow_a/b/c canonical-scenario starter cards.
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:7345:  3792	// E11-05 (2026-04-25): wow_a/b/c canonical-scenario starter cards.
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:7393:  3840	async function runWowScenario(wowId) {
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:7441:  3888	function installWowStarters() {
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:7449:  3896	        void runWowScenario(wowId);
.planning/phases/E11-workbench-engineer-first-ux/persona-P4-E11-05-output.md:7459:  3906	  installWowStarters();
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:16:You are Codex GPT-5.4 acting as **Persona P5 — Apps Engineer** (Tier-A 5-persona pipeline, E11-05 sub-phase).
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:18:# Shared context for E11-05 review (all 5 personas)
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:25:## What E11-05 ships
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:27:Per `E11-00-PLAN.md` row E11-05: top-of-/workbench one-click starter cards for the three demo wow scenarios.
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:32:- `src/well_harness/static/workbench.js` — NEW `WOW_SCENARIOS` const, `runWowScenario(wowId)`, `installWowStarters()`, plus 1 hook line in DOMContentLoaded.
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:33:- `src/well_harness/static/workbench_start.html` — 3 [REWRITE] lines updating stale claims that E11-05 hadn't shipped.
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:36:- `.planning/phases/E11-workbench-engineer-first-ux/PERSONA-ROTATION-STATE.md` — appended E11-05 = Tier-A.
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:86:Sign as: **P5 — Apps Engineer (Tier-A, E11-05)**
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:90:/bin/zsh -lc 'rg -n "ai-fantui-logicmvp|LogicMVP|E11-05|workbench wow|wow starters" /Users/Zhuanz/.codex/memories/MEMORY.md' in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:363:    54	        aria-label="Canonical demo scenarios — one-click starter cards"
...
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:648:     1	"""E11-05 — wow_a/b/c canonical-scenario starter cards regression lock.
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:650:     3	Locks the contract for the top-of-/workbench wow starter cards so future
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:652:     5	entrypoint. Per E11-00-PLAN row E11-05.
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:655:     8	  1. /workbench static HTML carries the three starter cards (one per
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:724:    77	# ─── 1. Static HTML carries all three starter cards ──────────────────
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:761:   114	def test_workbench_js_installWowStarters_wired_to_dom() -> None:
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:763:   116	    assert "function installWowStarters" in js
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:765:   118	    assert re.search(r"installWowStarters\s*\(\s*\)", js) is not None
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:818:   171	    """Live-served /workbench page includes the wow starters section."""
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:856:    30	      标记落地是为了 E11-05 / E11-08 / E11-11 这几期能基于它做角色化裁剪。
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:895:    69	        <li>wow_a/b/c 起手卡片已上线（E11-05），见 <code>/workbench</code> 顶部「起手卡」</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:934:   108	        wow_a/b/c 起手卡 已在 <code>/workbench</code> 顶部上线（E11-05），可以一键走读
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:940:   114	        <li>无-chrome demo mode 进入 E11-08 范围（wow_a 走读 已 E11-05 完成）</li>
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:1036:     1	# E11-05 Surface Inventory — wow_a/b/c canonical-scenario starter cards
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:1040:     5	> Records every user-facing string introduced by E11-05 and classifies each per the [ANCHORED/REWRITE/DELETE] taxonomy so the Tier-A vs Tier-B routing decision is auditable.
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:1058:    23	| 13 | `workbench_start.html` line ~69: "wow_a/b/c 起手卡片是 E11-05 范围，本期暂未上线" → "wow_a/b/c 起手卡片已上线（E11-05），见 /workbench 顶部「起手卡」" | [REWRITE] | `workbench_start.html:69` | Now that E11-05 ships, the placeholder is updated to a positive claim. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:1059:    24	| 14 | `workbench_start.html` line ~108: "wow_a/b/c 目前只在 tests/e2e/test_wow_a_causal_chain.py 里有，没有 UI 走读 surface" → "wow_a/b/c 起手卡 已在 /workbench 顶部上线（E11-05）…" | [REWRITE] | `workbench_start.html:107-108` | Removes the negative claim that no UI走读 surface exists. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:1060:    25	| 15 | `workbench_start.html` line ~113: "无-chrome demo mode + UI wow_a 走读 进入 E11-05/08 范围" → "无-chrome demo mode 进入 E11-08 范围（wow_a 走读 已 E11-05 完成）" | [REWRITE] | `workbench_start.html:113` | Removes the implicit claim that wow_a走读 is still pending; demarcates remaining E11-08 scope. |
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:1073:    38	Both thresholds are met: the 3 [REWRITE] lines on `workbench_start.html` are doc-truth corrections (placeholder copy that previously claimed E11-05 wasn't shipped). Per the rule's spirit — protect against stale copy reaching production — Tier-A is the conservative routing here.
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:1075:    40	> **Action: dispatch all 5 personas (P1–P5) for E11-05.**
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:1082:    47	- `src/well_harness/static/workbench.js` (NEW WOW_SCENARIOS const + runWowScenario + installWowStarters + 1 hook line in DOMContentLoaded)
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:1083:    48	- `src/well_harness/static/workbench_start.html` (3 [REWRITE] lines documenting that E11-05 has shipped)
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:1197:   107	/* E11-05 (2026-04-25): wow_a/b/c canonical-scenario starter cards.
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:3065:    13	E11-05: Tier-A (≥10 copy_diff_lines AND ≥3 [REWRITE]: 3 workbench_start.html corrections + 12 ANCHORED card copy lines). All 5 personas dispatched. Rotation pointer unchanged (Tier-A does not consume a Tier-B slot).
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:6861:  3792	// E11-05 (2026-04-25): wow_a/b/c canonical-scenario starter cards.
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:6909:  3840	async function runWowScenario(wowId) {
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:6957:  3888	function installWowStarters() {
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:6965:  3896	        void runWowScenario(wowId);
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:6975:  3906	  installWowStarters();
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:8191:/bin/zsh -lc "rg -n \"setFeedbackMode\\(|feedback_mode.*workbench-feedback-mode|workbench-trust-banner|runWowScenario|WOW_SCENARIOS\" src/well_harness/static/workbench.js" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:8201:3840:async function runWowScenario(wowId) {
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:8204:3896:        void runWowScenario(wowId);
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:8582:     1	"""E11-05 — wow_a/b/c canonical-scenario starter cards regression lock.
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:8584:     3	Locks the contract for the top-of-/workbench wow starter cards so future
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:8586:     5	entrypoint. Per E11-00-PLAN row E11-05.
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:8589:     8	  1. /workbench static HTML carries the three starter cards (one per
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:8658:    77	# ─── 1. Static HTML carries all three starter cards ──────────────────
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:8695:   114	def test_workbench_js_installWowStarters_wired_to_dom() -> None:
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:8697:   116	    assert "function installWowStarters" in js
.planning/phases/E11-workbench-engineer-first-ux/persona-P5-E11-05-output.md:8699:   118	    assert re.search(r"installWowStarters\s*\(\s*\)", js) is not None

exec
/bin/zsh -lc "nl -ba .github/workflows/rehearsal-smoke.yml | sed -n '1,180p'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
exec
/bin/zsh -lc "nl -ba .github/workflows/gsd-automation.yml | sed -n '1,140p'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
     1	name: rehearsal-smoke
     2	
     3	# Nightly + manual smoke lane for P20.2 dress rehearsal.
     4	# Explicitly NON-BLOCKING for main: no push/PR triggers, no required-check gating.
     5	# Purpose: catch demo-path regressions early without ever red-marking main CI.
     6	
     7	on:
     8	  schedule:
     9	    # 每日 UTC 18:00 (北京时间 02:00) 跑一次烟雾
    10	    - cron: "0 18 * * *"
    11	  workflow_dispatch:
    12	    inputs:
    13	      mode:
    14	        description: "rehearsal mode"
    15	        required: false
    16	        default: "smoke"
    17	        type: choice
    18	        options:
    ...
    25	jobs:
    26	  rehearsal-smoke:
    27	    # Intentionally no branch protection hook; this job's outcome does not
    28	    # affect merge eligibility for main. It only surfaces a status annotation.
    29	    runs-on: ubuntu-latest
    30	    timeout-minutes: 8
    31	    continue-on-error: true  # never block downstream workflows even on failure
    32	    steps:
    33	      - name: Checkout
    ...
    40	          cache: "pip"
    41	
    42	      - name: Install project (test extras)
    43	        run: |
    44	          python -m pip install --upgrade pip
    45	          pip install -e .
    46	          # test-only local dep for /api/* probing (bs4 not needed by smoke itself,
    47	          # but keeps parity with tests/e2e/ if a future step reuses it)
    48	          pip install beautifulsoup4
    49	
    50	      - name: Run dress rehearsal
    51	        id: rehearse
    52	        env:
    53	          REHEARSAL_MODE: ${{ github.event.inputs.mode || 'smoke' }}
    54	        run: |
    55	          set -euo pipefail
    56	          if [ "${REHEARSAL_MODE}" = "full" ]; then
    57	            python scripts/dress_rehearsal.py
    58	          else
    59	            python scripts/dress_rehearsal.py --smoke
    60	          fi
    61	
    62	      - name: Upload rehearsal artifacts
    63	        if: always()
    64	        uses: actions/upload-artifact@v4
    65	        with:
    66	          name: rehearsal-${{ github.run_id }}
    67	          path: runs/dress_rehearsal_*/
    68	          if-no-files-found: warn
    69	          retention-days: 14

 succeeded in 0ms:
     1	name: GSD Automation Loop
     2	
     3	on:
     4	  workflow_dispatch:
     5	    inputs:
     6	      opus_gate:
     7	        description: "Move the Opus 4.6 review gate to Awaiting Opus 4.6 after successful checks"
     8	        required: false
     9	        default: "false"
    10	  push:
    11	    branches:
    ...
    13	
    14	jobs:
    15	  # Stage 1: Run regression tests
    16	  regression:
    ...
    32	        run: python3 -m unittest discover -s tests -p test_gsd_notion_sync.py -q
    33	
    34	  # Stage 2: Run full GSD validation suite
    35	  validation:
    ...
    52	        shell: bash
    53	        # Install all [dev] extras from pyproject.toml so CI matches local runs.
    54	        # Previously only installed jsonschema + pytest, missing pytest-subtests / numpy / pyyaml.
    55	        run: pip install -e '.[dev]'
    56	
    57	      - name: Run GSD validation suite
    58	        run: python3 tools/run_gsd_validation_suite.py --format json
    59	
    60	  # Stage 3: Sync repo docs to Notion (non-blocking)
    61	  notion-sync:
    ...
    68	      NOTION_API_KEY: ${{ secrets.NOTION_API_KEY }}
    69	      PYTHONPATH: src
    70	    steps:
    ...
    78	
    79	      - name: Sync repo docs to Notion
    80	        run: |
    81	          python3 tools/gsd_notion_sync.py sync-repo-docs --format json --cwd .
    82	        continue-on-error: true
    83	
    84	      - name: Prepare Opus review brief
    85	        if: always()
    86	        run: |
    87	          OPUS_CMD="--dry-run"
    88	          if [[ "${{ github.event.inputs.opus_gate }}" == "true" ]]; then
    89	            OPUS_CMD="--activate-gate"
    90	          fi
    91	          python3 tools/gsd_notion_sync.py prepare-opus-review $OPUS_CMD --format json
    92	        continue-on-error: true

exec
/bin/zsh -lc 'rg -n "function runWowScenario|function installWowStarters|const WOW_SCENARIOS|data-wow-id=|data-wow-result-for=|workbench-wow-run-button|workbench-wow-result" src/well_harness/static/workbench.js src/well_harness/static/workbench.html tests/test_workbench_wow_starters.py' in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
tests/test_workbench_wow_starters.py:90:    assert f'data-wow-id="{wow_id}"' in html, f"missing card for {wow_id}"
tests/test_workbench_wow_starters.py:92:        f'data-wow-result-for="{wow_id}"' in html
tests/test_workbench_wow_starters.py:102:    assert "const WOW_SCENARIOS" in js
tests/test_workbench_wow_starters.py:116:    assert "function installWowStarters" in js
tests/test_workbench_wow_starters.py:175:    assert 'data-wow-id="wow_a"' in html
tests/test_workbench_wow_starters.py:176:    assert 'data-wow-id="wow_b"' in html
tests/test_workbench_wow_starters.py:177:    assert 'data-wow-id="wow_c"' in html
src/well_harness/static/workbench.html:66:            data-wow-id="wow_a"
src/well_harness/static/workbench.html:79:              class="workbench-wow-run-button"
src/well_harness/static/workbench.html:81:              data-wow-id="wow_a"
src/well_harness/static/workbench.html:86:              class="workbench-wow-result"
src/well_harness/static/workbench.html:87:              data-wow-result-for="wow_a"
src/well_harness/static/workbench.html:96:            data-wow-id="wow_b"
src/well_harness/static/workbench.html:109:              class="workbench-wow-run-button"
src/well_harness/static/workbench.html:111:              data-wow-id="wow_b"
src/well_harness/static/workbench.html:116:              class="workbench-wow-result"
src/well_harness/static/workbench.html:117:              data-wow-result-for="wow_b"
src/well_harness/static/workbench.html:126:            data-wow-id="wow_c"
src/well_harness/static/workbench.html:139:              class="workbench-wow-run-button"
src/well_harness/static/workbench.html:141:              data-wow-id="wow_c"
src/well_harness/static/workbench.html:146:              class="workbench-wow-result"
src/well_harness/static/workbench.html:147:              data-wow-result-for="wow_c"
src/well_harness/static/workbench.js:3796:const WOW_SCENARIOS = {
src/well_harness/static/workbench.js:3840:async function runWowScenario(wowId) {
src/well_harness/static/workbench.js:3843:    `.workbench-wow-run-button[data-wow-id="${wowId}"]`,
src/well_harness/static/workbench.js:3846:    `.workbench-wow-result[data-wow-result-for="${wowId}"]`,
src/well_harness/static/workbench.js:3888:function installWowStarters() {
src/well_harness/static/workbench.js:3890:    '.workbench-wow-run-button[data-wow-action="run"]',

exec
/bin/zsh -lc "rg -n \"importorskip|ModuleNotFoundError|jsonschema is unavailable|optional dependency|skip\\(\" tests src/well_harness -g '"'!**/__pycache__/**'"'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
tests/test_provenance_sha_integrity.py:65:        pytest.skip("uploads/ directory absent; nothing to register")
tests/test_landing_gear_diagnosis_validation.py:34:        if "SKIP: optional dependency 'jsonschema' is not installed" in result.stdout:
tests/test_landing_gear_diagnosis_validation.py:35:            self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_landing_gear_diagnosis_validation.py:46:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_landing_gear_diagnosis_validation.py:83:        self.assertIn("optional dependency 'jsonschema' is not installed", payload["reason"])
tests/test_fault_diagnosis.py:132:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_fault_diagnosis.py:155:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_workbench_archive_manifest_schema.py:34:        if "SKIP: optional dependency 'jsonschema' is not installed" in result.stdout:
tests/test_workbench_archive_manifest_schema.py:35:            self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_workbench_archive_manifest_schema.py:47:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_workbench_archive_manifest_schema.py:81:        self.assertIn("optional dependency 'jsonschema' is not installed", payload["reason"])
tests/test_demo.py:193:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_demo.py:223:        if "SKIP: optional dependency 'jsonschema' is not installed" in result.stdout:
tests/test_demo.py:231:    def test_demo_answer_schema_standalone_script_forced_skip(self):
tests/test_demo.py:243:        self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_demo.py:250:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_demo.py:299:        self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", payload["reason"])
tests/test_two_system_runtime_comparison.py:60:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_knowledge_artifact_schema.py:34:        if "SKIP: optional dependency 'jsonschema' is not installed" in result.stdout:
tests/test_knowledge_artifact_schema.py:35:            self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_knowledge_artifact_schema.py:45:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_knowledge_artifact_schema.py:77:        self.assertIn("optional dependency 'jsonschema' is not installed", payload["reason"])
tests/test_two_system_runtime_comparison_schema.py:34:        if "SKIP: optional dependency 'jsonschema' is not installed" in result.stdout:
tests/test_two_system_runtime_comparison_schema.py:35:            self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_two_system_runtime_comparison_schema.py:45:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_two_system_runtime_comparison_schema.py:79:        self.assertIn("optional dependency 'jsonschema' is not installed", payload["reason"])
tests/test_landing_gear_adapter_validation.py:34:        if "SKIP: optional dependency 'jsonschema' is not installed" in result.stdout:
tests/test_landing_gear_adapter_validation.py:35:            self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_landing_gear_adapter_validation.py:46:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_landing_gear_adapter_validation.py:84:        self.assertIn("optional dependency 'jsonschema' is not installed", payload["reason"])
tests/test_cli.py:624:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_cli.py:650:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_cli.py:656:        self.assertNotIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_cli.py:658:    def test_validation_script_smoke_forced_skip(self):
tests/test_cli.py:663:            "SKIP: optional dependency 'jsonschema' is not installed",
tests/test_cli.py:750:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_cli.py:775:        self.assertIn("optional dependency 'jsonschema' is not installed", payload["reason"])
tests/test_cli.py:946:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_cli.py:979:                "SKIP: optional dependency 'jsonschema' is not installed",
tests/test_cli.py:997:            self.assertNotIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_cli.py:1000:    def test_validation_report_schema_standalone_script_forced_skip(self):
tests/test_cli.py:1005:            "SKIP: optional dependency 'jsonschema' is not installed",
tests/test_cli.py:1015:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_cli.py:1215:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_cli.py:1251:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_cli.py:1291:                "SKIP: optional dependency 'jsonschema' is not installed",
tests/test_cli.py:1301:            self.assertNotIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_cli.py:1304:    def test_validation_schema_checker_report_schema_standalone_script_forced_skip(self):
tests/test_cli.py:1311:            "SKIP: optional dependency 'jsonschema' is not installed",
tests/test_cli.py:1325:                "SKIP: optional dependency 'jsonschema' is not installed",
tests/test_cli.py:1335:            self.assertNotIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_cli.py:1338:    def test_validation_schema_runner_report_schema_standalone_script_forced_skip(self):
tests/test_cli.py:1345:            "SKIP: optional dependency 'jsonschema' is not installed",
tests/test_cli.py:1355:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_system_spec.py:104:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_c919_etras_adapter.py:157:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_c919_etras_adapter.py:689:            self.skipTest("optional dependency pyyaml not installed")
tests/test_c919_etras_adapter.py:706:            self.skipTest("optional dependency pyyaml not installed")
tests/test_fault_diagnosis_schema.py:34:        if "SKIP: optional dependency 'jsonschema' is not installed" in result.stdout:
tests/test_fault_diagnosis_schema.py:35:            self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_fault_diagnosis_schema.py:45:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_fault_diagnosis_schema.py:77:        self.assertIn("optional dependency 'jsonschema' is not installed", payload["reason"])
tests/test_landing_gear_adapter.py:55:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_fault_taxonomy.py:41:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_knowledge_capture.py:146:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_knowledge_capture.py:174:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_second_system_smoke_schema.py:34:        if "SKIP: optional dependency 'jsonschema' is not installed" in result.stdout:
tests/test_second_system_smoke_schema.py:35:            self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_second_system_smoke_schema.py:49:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_second_system_smoke_schema.py:87:        self.assertIn("optional dependency 'jsonschema' is not installed", payload["reason"])
tests/test_scenario_playback.py:145:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_scenario_playback.py:167:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_control_system_spec_schema.py:34:        if "SKIP: optional dependency 'jsonschema' is not installed" in result.stdout:
tests/test_control_system_spec_schema.py:35:            self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_control_system_spec_schema.py:47:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_control_system_spec_schema.py:81:        self.assertIn("optional dependency 'jsonschema' is not installed", payload["reason"])
tests/test_landing_gear_full_pipeline_validation.py:35:        if "SKIP: optional dependency 'jsonschema'" not in result.stdout:
tests/test_landing_gear_full_pipeline_validation.py:47:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_landing_gear_full_pipeline_validation.py:77:        """When jsonschema is unavailable, script exits 0 with status=skip."""
tests/test_landing_gear_full_pipeline_validation.py:97:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_playback_trace_schema.py:34:        if "SKIP: optional dependency 'jsonschema' is not installed" in result.stdout:
tests/test_playback_trace_schema.py:35:            self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_playback_trace_schema.py:45:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_playback_trace_schema.py:77:        self.assertIn("optional dependency 'jsonschema' is not installed", payload["reason"])
tests/test_workbench_bundle.py:150:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_workbench_bundle.py:345:            self.skipTest("optional dependency jsonschema is not installed")
src/well_harness/hardware_schema.py:180:        import yaml  # PyYAML — optional dependency
tests/test_landing_gear_knowledge_validation.py:34:        if "SKIP: optional dependency 'jsonschema' is not installed" in result.stdout:
tests/test_landing_gear_knowledge_validation.py:35:            self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_landing_gear_knowledge_validation.py:46:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_landing_gear_knowledge_validation.py:83:        self.assertIn("optional dependency 'jsonschema' is not installed", payload["reason"])
tests/test_landing_gear_playback_validation.py:34:        if "SKIP: optional dependency 'jsonschema' is not installed" in result.stdout:
tests/test_landing_gear_playback_validation.py:35:            self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_landing_gear_playback_validation.py:46:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_landing_gear_playback_validation.py:83:        self.assertIn("optional dependency 'jsonschema' is not installed", payload["reason"])
tests/test_controller_adapter.py:83:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_workbench_bundle_schema.py:34:        if "SKIP: optional dependency 'jsonschema' is not installed" in result.stdout:
tests/test_workbench_bundle_schema.py:35:            self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_workbench_bundle_schema.py:47:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_workbench_bundle_schema.py:81:        self.assertIn("optional dependency 'jsonschema' is not installed", payload["reason"])
tests/fixtures/validation_schema_runner_report_asset_v1.json:46:    "expected_reason_contains": "optional dependency 'jsonschema' is not installed"
tests/test_controller_truth_metadata_schema_extension.py:159:            self.skipTest("optional dependency jsonschema is not installed")
tests/fixtures/validation_report_asset_v1.json:50:      "expected_reason_contains": "optional dependency 'jsonschema' is not installed"
tests/test_fault_taxonomy_schema.py:34:        if "SKIP: optional dependency 'jsonschema' is not installed" in result.stdout:
tests/test_fault_taxonomy_schema.py:35:            self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_fault_taxonomy_schema.py:46:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_fault_taxonomy_schema.py:82:        self.assertIn("optional dependency 'jsonschema' is not installed", payload["reason"])
tests/test_second_system_smoke.py:83:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_controller_truth_adapter_metadata_schema.py:34:        if "SKIP: optional dependency 'jsonschema' is not installed" in result.stdout:
tests/test_controller_truth_adapter_metadata_schema.py:35:            self.assertIn("SKIP: optional dependency 'jsonschema' is not installed", result.stdout)
tests/test_controller_truth_adapter_metadata_schema.py:47:            self.skipTest("optional dependency jsonschema is not installed")
tests/test_controller_truth_adapter_metadata_schema.py:89:        self.assertIn("optional dependency 'jsonschema' is not installed", payload["reason"])
tests/fixtures/validation_schema_checker_report_asset_v1.json:42:    "expected_reason_contains": "optional dependency 'jsonschema' is not installed"

codex
I’ve isolated one concrete review risk already: the PR’s advertised quick-check command is not reproducible on the default interpreter in this checkout. I’m running the same test file in a clean temporary venv with `.[dev]` installed next, so I can separate “code bug” from “environment contract bug” before I issue the final verdict.
exec
/bin/zsh -lc "python3 -m venv /tmp/logicmvp-e11-05-review && source /tmp/logicmvp-e11-05-review/bin/activate && python -m pip install --upgrade pip >/tmp/logicmvp-e11-05-pip-upgrade.log && pip install -e '.[dev]' >/tmp/logicmvp-e11-05-install.log && pytest tests/test_workbench_wow_starters.py -q" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 41696ms:
..........                                                               [100%]
10 passed in 7.78s

exec
/bin/zsh -lc "nl -ba tests/e2e/test_wow_c_reverse_diagnose.py | sed -n '1,140p'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
exec
/bin/zsh -lc "nl -ba tests/e2e/test_wow_b_monte_carlo.py | sed -n '1,120p'" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
...
exec
/bin/zsh -lc "rg -n \"system-select|workbench-system-select|setFeedbackMode\\(|data-wow-state|aria-live|focus-visible|disabled\" src/well_harness/static/workbench.html src/well_harness/static/workbench.css src/well_harness/static/workbench.js" in /Users/Zhuanz/Documents/Codex/2026-04-18-computer-use-plugin-computer-use-openai/ai-fantui-logicmvp
 succeeded in 0ms:
src/well_harness/static/workbench.css:207:.workbench-wow-run-button:hover:not([disabled]) {
src/well_harness/static/workbench.css:211:.workbench-wow-run-button[disabled] {
src/well_harness/static/workbench.css:229:.workbench-wow-result[data-wow-state="ok"] {
src/well_harness/static/workbench.css:234:.workbench-wow-result[data-wow-state="error"] {
src/well_harness/static/workbench.css:637:.workbench-toolbar-button:focus-visible,
src/well_harness/static/workbench.css:638:.workbench-run-button:focus-visible,
src/well_harness/static/workbench.css:639:.workbench-file-picker:focus-visible {
src/well_harness/static/workbench.css:647:.workbench-toolbar-button[disabled],
src/well_harness/static/workbench.css:648:.workbench-run-button[disabled],
src/well_harness/static/workbench.css:649:.workbench-file-picker[disabled] {
src/well_harness/static/workbench.css:1228:.workbench-clarification-card textarea:focus-visible {
src/well_harness/static/workbench.css:1233:.workbench-clarification-card textarea:disabled {
src/well_harness/static/workbench.css:1550:.workbench-history-return-button:disabled {
src/well_harness/static/workbench.css:1555:.workbench-history-return-button:not(:disabled) {
src/well_harness/static/workbench.css:1590:.workbench-history-card:focus-visible {
...
src/well_harness/static/workbench.html:42:          <select id="workbench-system-select">
src/well_harness/static/workbench.html:89:              aria-live="polite"
src/well_harness/static/workbench.html:119:              aria-live="polite"
src/well_harness/static/workbench.html:149:              aria-live="polite"
src/well_harness/static/workbench.html:193:        <span id="workbench-annotation-active-tool" class="workbench-annotation-active-tool" aria-live="polite">
src/well_harness/static/workbench.html:210:          <div id="workbench-control-status" class="workbench-collab-status" aria-live="polite">
src/well_harness/static/workbench.html:230:          <div id="workbench-document-status" class="workbench-collab-status" aria-live="polite">
src/well_harness/static/workbench.html:250:          <div id="workbench-circuit-status" class="workbench-collab-status" aria-live="polite">
src/well_harness/static/workbench.js:131:  if (approveBtn)  approveBtn.disabled  = !approveEnabled;
src/well_harness/static/workbench.js:132:  if (startGenBtn) startGenBtn.disabled = !startGenEnabled;
src/well_harness/static/workbench.js:1151:  textarea.disabled = !editable;
src/well_harness/static/workbench.js:1321:function setSchemaRepairActionState(disabled) {
src/well_harness/static/workbench.js:1322:  workbenchElement("workbench-apply-schema-repairs").disabled = disabled;
src/well_harness/static/workbench.js:1397:function setClarificationWorkspaceActionState(disabled) {
src/well_harness/static/workbench.js:1398:  workbenchElement("workbench-apply-clarifications").disabled = disabled;
src/well_harness/static/workbench.js:1399:  workbenchElement("workbench-apply-and-rerun").disabled = disabled;
src/well_harness/static/workbench.js:1755:    returnButton.disabled = true;
src/well_harness/static/workbench.js:1763:    returnButton.disabled = true;
src/well_harness/static/workbench.js:1770:  returnButton.disabled = false;
src/well_harness/static/workbench.js:1775:function setPacketDraftActionState(disabled) {
src/well_harness/static/workbench.js:1776:  workbenchElement("workbench-save-packet-draft").disabled = disabled;
src/well_harness/static/workbench.js:2447:    returnButton.disabled = true;
src/well_harness/static/workbench.js:2455:    returnButton.disabled = true;
src/well_harness/static/workbench.js:2463:    returnButton.disabled = true;
src/well_harness/static/workbench.js:2471:    returnButton.disabled = true;
src/well_harness/static/workbench.js:2478:  returnButton.disabled = false;
src/well_harness/static/workbench.js:3743:// manual_feedback_override. Provides setFeedbackMode(mode) for runtime updates
src/well_harness/static/workbench.js:3754:function setFeedbackMode(mode) {
src/well_harness/static/workbench.js:3852:    button.disabled = true;
src/well_harness/static/workbench.js:3854:  result.removeAttribute("data-wow-state");
src/well_harness/static/workbench.js:3871:      result.setAttribute("data-wow-state", "error");
src/well_harness/static/workbench.js:3876:    result.setAttribute("data-wow-state", "ok");
src/well_harness/static/workbench.js:3879:    result.setAttribute("data-wow-state", "error");
src/well_harness/static/workbench.js:3883:      button.disabled = false;

codex
I have enough to close the review. The code stays on the UI side of the red line, and the same-button click path is basically safe, but I’m landing on `CHANGES_REQUIRED` because there are two front-end honesty/resilience gaps in the new wow handler that are easy to miss in happy-path testing.
  ✓ Confirm red-line diff and changed-file scope between a17e744 and a02729a
  ✓ Read all in-scope files and inspect diffs with line references
  ✓ Run targeted validation for wow starter tests and, if useful, a live probe
  → Issue P1 review verdict with severity-tagged findings
...
- **BLOCKER** — `src/well_harness/static/workbench.js:3810`  
  `wow_a` always reports `L1–L4 chain latched.` but it never reads the contract-bearing gate fields. The summary only counts `body.nodes`; the actual truth for that claim lives in `body.logic.logic1..logic4` (`tests/e2e/test_wow_a_causal_chain.py:79`, `tests/e2e/test_wow_a_causal_chain.py:121`). If `/api/lever-snapshot` ever returns a partial chain on `200`, the UI will still overstate success.

- **BLOCKER** — `src/well_harness/static/workbench.js:3851`  
  The click path disables the button and waits on raw `fetch()` with no timeout or abort path. If an endpoint stalls instead of failing fast, the card stays stuck in `POST ...` and the operator cannot retry until the browser/network stack gives up. For a top-of-workbench demo starter, that is too brittle; it needs a bounded timeout and deterministic recovery text.

- **IMPORTANT** — `tests/test_workbench_wow_starters.py:99`, `tests/test_workbench_wow_starters.py:114`, `tests/test_workbench_wow_starters.py:142`, `tests/test_workbench_wow_starters.py:156`  
...
No same-button reentry race jumped out to me: `button.disabled = true` happens before the first `await`, so duplicate clicks on the same card are mostly guarded. My concern is the stalled-request path, not double-submit.

Truth-engine red line check passed: `git diff --name-only a17e744..a02729a` only shows `.planning/`, `src/well_harness/static/`, and `tests/test_workbench_wow_starters.py`; there are zero changes to `controller.py`, `runner.py`, `models.py`, or `src/well_harness/adapters/`.

Probe note: `python3 -m pytest tests/test_workbench_wow_starters.py -q` failed on the default CLT Python here because `numpy`/`jsonschema` were absent, but the same file passed `10 passed in 7.78s` in a temp venv after `pip install -e '.[dev]'`. So the quick-check is environment-sensitive rather than inherently broken.

**P1 — Junior FCS Engineer (Tier-A, E11-05)**
