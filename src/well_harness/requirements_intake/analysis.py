...
def _deterministic_c919_etras_v09_preparse(records: list[dict[str, str]]) -> dict[str, Any]:
    ...
    cmd3_sr_output_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_cmd3_sr_output"],
        "C919-V09-CMD3-SR-OUTPUT",
    )
    cmd3_reset_priority_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_cmd3_reset_priority"],
        "C919-V09-CMD3-RESET-PRIORITY",
    )
    deploy_anchors = _c919_anchor(records, _C919_ETRAS_PATTERNS["v09_deploy"], "C919-V09-DEPLOY-CMD1")
    deploy_output_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_deploy_output"],
        "C919-V09-DEPLOY-CMD1-OUTPUT",
    )
    deploy_engine_condition_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_deploy_engine_condition"],
        "C919-V09-DEPLOY-CMD1-ENGINE",
    )
    deploy_inhibited_condition_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_deploy_inhibited_condition"],
        "C919-V09-DEPLOY-CMD1-INHIBITED",
    )
    deploy_locks_condition_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_deploy_locks_condition"],
        "C919-V09-DEPLOY-CMD1-LOCKS",
    )
    deploy_tr_wow_condition_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_deploy_tr_wow_condition"],
        "C919-V09-DEPLOY-CMD1-TR-WOW",
    )
    deploy_n1k_condition_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_deploy_n1k_condition"],
        "C919-V09-DEPLOY-CMD1-N1K",
    )
    deploy_tra_condition_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_deploy_tra_condition"],
        "C919-V09-DEPLOY-CMD1-TRA",
    )
    eval_cmd3_output_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_eval_cmd3_output"],
        "C919-V09-EVAL-CMD3-SR-OUTPUT",
    )
    eval_deploy_cmd1_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_eval_deploy_cmd1"],
        "C919-V09-EVAL-DEPLOY-CMD1",
    )
    eval_thr_idle_lock_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_eval_thr_idle_lock"],
        "C919-V09-EVAL-THR-IDLE-LOCK",
    )
    mlg_wow_anchors = _c919_anchor(records, _C919_ETRAS_PATTERNS["v09_mlg_wow"], "C919-V09-MLG-WOW")
    cmd2_mlg_wow_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_cmd2_mlg_wow_condition"],
        "C919-V09-CMD2-MLG-WOW",
    )
    cmd3_apwtla_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_cmd3_apwtla_condition"],
    ...
    thr_idle_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_thr_idle_lock"],
        "C919-V09-THR-IDLE-LOCK",
    )
    thr_idle_output_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_thr_idle_output"],
        "C919-V09-THR-IDLE-OUTPUT",
    )
    thr_idle_condition_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_thr_idle_tr_deployed_condition"],
        "C919-V09-THR-IDLE-TR-DEPLOYED",
    )
    thr_idle_position_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_thr_idle_position_confirm"],
        "C919-V09-THR-IDLE-POS-CONF",
    )
    accept_thr_idle_lock_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_accept_thr_idle_lock"],
        "C919-V09-ACCEPT-THR-IDLE-LOCK",
    )
    pre_freeze_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["v09_pre_freeze"],
        "C919-V09-PRE-FREEZE",
    )
    if not (
        domain_records
...
def _deterministic_c919_etras_preparse(document_text: str) -> dict[str, Any]:
    ...
    if any(
        signal_id != "domain"
        for signal_id in v09_facts.get("present_signal_ids", [])
    ):
        return v09_facts
    ...
    handle_anchors = _c919_anchor(
        records,
        _C919_ETRAS_PATTERNS["handle_unlock"],
        "C919-ETRAS-HANDLE",
    )
    ...
    edges = [
        _edge("c919_e1", "wow_valid", "etras_armed", "WOW gating", wow_gate_anchors),
    ]
    if handle_anchors:
        edges.append(
            _edge(
    ...
    return {
        ...
        "detected": {
            ...
            "signal_ids": [
                "wow_valid",
                "etras_armed",
                *([] if not handle_anchors else ["handle_unlock_range"]),
            ],
            "anchor_count": len(records),
        },
    }
...
def _deterministic_local_preparse(document_text: str) -> dict[str, Any]:
    ...
    if l1_l4_facts.get("available"):
        return l1_l4_facts
    c919_facts = _deterministic_c919_etras_preparse(document_text)
