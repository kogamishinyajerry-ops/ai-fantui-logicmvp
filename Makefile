...
multi-agent-owner-acceptance-handoff:
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_review_closure.py --format json --artifact-dir "$(MULTI_AGENT_REVIEW_CLOSURE_ARTIFACT_DIR)" >/dev/null
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_release_decision_input.py --format json --artifact-dir "$(MULTI_AGENT_RELEASE_DECISION_INPUT_ARTIFACT_DIR)" --review-closure "$(MULTI_AGENT_REVIEW_CLOSURE_ARTIFACT_DIR)/multi_agent_review_closure_v0_1.json" >/dev/null
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_owner_acceptance_handoff.py --format json --artifact-dir "$(MULTI_AGENT_OWNER_ACCEPTANCE_HANDOFF_ARTIFACT_DIR)" --release-decision-input "$(MULTI_AGENT_RELEASE_DECISION_INPUT_ARTIFACT_DIR)/multi_agent_release_decision_input_v0_1.json"
...
verify-multi-agent-owner-acceptance-handoff:
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_review_closure.py --format json --artifact-dir "$(MULTI_AGENT_REVIEW_CLOSURE_ARTIFACT_DIR)" >/dev/null
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_release_decision_input.py --format json --artifact-dir "$(MULTI_AGENT_RELEASE_DECISION_INPUT_ARTIFACT_DIR)" --review-closure "$(MULTI_AGENT_REVIEW_CLOSURE_ARTIFACT_DIR)/multi_agent_review_closure_v0_1.json" >/dev/null
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_owner_acceptance_handoff.py --format json --artifact-dir "$(MULTI_AGENT_OWNER_ACCEPTANCE_HANDOFF_ARTIFACT_DIR)" --release-decision-input "$(MULTI_AGENT_RELEASE_DECISION_INPUT_ARTIFACT_DIR)/multi_agent_release_decision_input_v0_1.json" >/dev/null
