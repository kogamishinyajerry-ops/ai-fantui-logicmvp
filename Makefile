...
MULTI_AGENT_REVIEW_CLOSURE_ARTIFACT_DIR ?= /tmp/ai-fantui-multi-agent-review-closure
MULTI_AGENT_RELEASE_DECISION_INPUT_ARTIFACT_DIR ?= /tmp/ai-fantui-multi-agent-release-decision-input
MULTI_AGENT_OWNER_ACCEPTANCE_HANDOFF_ARTIFACT_DIR ?= /tmp/ai-fantui-multi-agent-owner-acceptance-handoff
MULTI_AGENT_OWNER_DECISION_REQUEST_ARTIFACT_DIR ?= /tmp/ai-fantui-multi-agent-owner-decision-request
...
PHASE1_DEMO_MVP_BASELINE_HANDOFF_ARTIFACT_DIR ?= /tmp/ai-fantui-phase1-demo-mvp-baseline-handoff
...
.PHONY: demo-html-reconstruction-complete-link
...
help:
	...
	@echo "  make phase1-demo-mvp-baseline-handoff — generate and verify the Phase 1 demo MVP baseline handoff"
	...
	@echo "  make project-progress-cockpit — open the simplified project progress cockpit"
	...
	@echo "  make multi-agent-review-closure — emit the M30 current-head review closure packet"
	@echo "  make verify-multi-agent-review-closure — validate the M30 review closure packet"
	@echo "  make multi-agent-release-decision-input — emit the M31 owner release decision input"
	@echo "  make verify-multi-agent-release-decision-input — validate the M31 release decision input"
	@echo "  make multi-agent-owner-acceptance-handoff — emit the M32 owner acceptance handoff"
	@echo "  make verify-multi-agent-owner-acceptance-handoff — validate the M32 owner acceptance handoff"
	@echo "  make multi-agent-owner-decision-request — emit the M33 owner decision request"
	@echo "  make verify-multi-agent-owner-decision-request — validate the M33 owner decision request"
...
phase1-demo-mvp-baseline-handoff:
	@PYTHONPATH=src:. python3 scripts/run_phase1_demo_mvp_baseline_handoff.py --format json --artifact-dir "$(PHASE1_DEMO_MVP_BASELINE_HANDOFF_ARTIFACT_DIR)" --gate-artifact-dir "$(PHASE1_DEMO_MVP_GATE_ARTIFACT_DIR)"
	@PYTHONPATH=src:. python3 scripts/verify_phase1_demo_mvp_baseline_handoff.py --format json --package "$(PHASE1_DEMO_MVP_BASELINE_HANDOFF_ARTIFACT_DIR)/phase1_demo_mvp_baseline_handoff_v0_1.json"

verify-phase1-demo-mvp-baseline-handoff:
	@PYTHONPATH=src:. python3 scripts/verify_phase1_demo_mvp_baseline_handoff.py --format json --package "$(PHASE1_DEMO_MVP_BASELINE_HANDOFF_ARTIFACT_DIR)/phase1_demo_mvp_baseline_handoff_v0_1.json"
...
project-progress-cockpit: multi-agent-operator-cockpit

verify-project-progress-cockpit: verify-multi-agent-operator-cockpit
...
multi-agent-review-closure:
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_review_closure.py --format json --artifact-dir "$(MULTI_AGENT_REVIEW_CLOSURE_ARTIFACT_DIR)"
	@printf 'Open: %s\n' "$(MULTI_AGENT_REVIEW_CLOSURE_ARTIFACT_DIR)/multi_agent_review_closure_v0_1.html"

verify-multi-agent-review-closure:
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_review_closure.py --format json --artifact-dir "$(MULTI_AGENT_REVIEW_CLOSURE_ARTIFACT_DIR)" >/dev/null
	@PYTHONPATH=src:. python3 scripts/verify_multi_agent_review_closure.py --format json --artifact-dir "$(MULTI_AGENT_REVIEW_CLOSURE_ARTIFACT_DIR)"

multi-agent-release-decision-input:
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_review_closure.py --format json --artifact-dir "$(MULTI_AGENT_REVIEW_CLOSURE_ARTIFACT_DIR)" >/dev/null
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_release_decision_input.py --format json --artifact-dir "$(MULTI_AGENT_RELEASE_DECISION_INPUT_ARTIFACT_DIR)" --review-closure "$(MULTI_AGENT_REVIEW_CLOSURE_ARTIFACT_DIR)/multi_agent_review_closure_v0_1.json"
	@printf 'Open: %s\n' "$(MULTI_AGENT_RELEASE_DECISION_INPUT_ARTIFACT_DIR)/multi_agent_release_decision_input_v0_1.html"

verify-multi-agent-release-decision-input:
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_review_closure.py --format json --artifact-dir "$(MULTI_AGENT_REVIEW_CLOSURE_ARTIFACT_DIR)" >/dev/null
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_release_decision_input.py --format json --artifact-dir "$(MULTI_AGENT_RELEASE_DECISION_INPUT_ARTIFACT_DIR)" --review-closure "$(MULTI_AGENT_REVIEW_CLOSURE_ARTIFACT_DIR)/multi_agent_review_closure_v0_1.json" >/dev/null
	@PYTHONPATH=src:. python3 scripts/verify_multi_agent_release_decision_input.py --format json --artifact-dir "$(MULTI_AGENT_RELEASE_DECISION_INPUT_ARTIFACT_DIR)"

multi-agent-owner-acceptance-handoff:
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_owner_acceptance_handoff.py --refresh-release-decision-input --format json --artifact-dir "$(MULTI_AGENT_OWNER_ACCEPTANCE_HANDOFF_ARTIFACT_DIR)" --release-decision-input "$(MULTI_AGENT_RELEASE_DECISION_INPUT_ARTIFACT_DIR)/multi_agent_release_decision_input_v0_1.json"
	@printf 'Open: %s\n' "$(MULTI_AGENT_OWNER_ACCEPTANCE_HANDOFF_ARTIFACT_DIR)/multi_agent_owner_acceptance_handoff_v0_1.html"

verify-multi-agent-owner-acceptance-handoff:
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_owner_acceptance_handoff.py --refresh-release-decision-input --format json --artifact-dir "$(MULTI_AGENT_OWNER_ACCEPTANCE_HANDOFF_ARTIFACT_DIR)" --release-decision-input "$(MULTI_AGENT_RELEASE_DECISION_INPUT_ARTIFACT_DIR)/multi_agent_release_decision_input_v0_1.json" >/dev/null
	@PYTHONPATH=src:. python3 scripts/verify_multi_agent_owner_acceptance_handoff.py --format json --artifact-dir "$(MULTI_AGENT_OWNER_ACCEPTANCE_HANDOFF_ARTIFACT_DIR)"

multi-agent-owner-decision-request:
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_owner_acceptance_handoff.py --refresh-release-decision-input --format json --artifact-dir "$(MULTI_AGENT_OWNER_ACCEPTANCE_HANDOFF_ARTIFACT_DIR)" >/dev/null
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_owner_decision_request.py --format json --artifact-dir "$(MULTI_AGENT_OWNER_DECISION_REQUEST_ARTIFACT_DIR)" --owner-acceptance-handoff "$(MULTI_AGENT_OWNER_ACCEPTANCE_HANDOFF_ARTIFACT_DIR)/multi_agent_owner_acceptance_handoff_v0_1.json"
	@printf 'Open: %s\n' "$(MULTI_AGENT_OWNER_DECISION_REQUEST_ARTIFACT_DIR)/multi_agent_owner_decision_request_v0_1.html"

verify-multi-agent-owner-decision-request:
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_owner_acceptance_handoff.py --refresh-release-decision-input --format json --artifact-dir "$(MULTI_AGENT_OWNER_ACCEPTANCE_HANDOFF_ARTIFACT_DIR)" >/dev/null
	@PYTHONPATH=src:. python3 scripts/run_multi_agent_owner_decision_request.py --format json --artifact-dir "$(MULTI_AGENT_OWNER_DECISION_REQUEST_ARTIFACT_DIR)" --owner-acceptance-handoff "$(MULTI_AGENT_OWNER_ACCEPTANCE_HANDOFF_ARTIFACT_DIR)/multi_agent_owner_acceptance_handoff_v0_1.json" >/dev/null
	@PYTHONPATH=src:. python3 scripts/verify_multi_agent_owner_decision_request.py --format json --artifact-dir "$(MULTI_AGENT_OWNER_DECISION_REQUEST_ARTIFACT_DIR)"

test: demo-html-reconstruction-mvp review-packet-export-regression verify-approved-repair-slices-artifact verify-approved-candidate-task-queue-artifact verify-approved-candidate-task-queue-expansion-contract verify-approved-candidate-task-queue-v0-2-artifact verify-approved-candidate-task-queue-v0-3-artifact verify-approved-candidate-task-queue-v0-4-artifact verify-approved-candidate-task-queue-v0-5-artifact verify-approved-candidate-task-queue-v0-6-artifact verify-approved-candidate-task-queue-v0-7-artifact verify-approved-candidate-task-queue-v0-8-artifact verify-approved-candidate-task-queue-v0-9-artifact verify-multi-agent-queue-run-ledger verify-multi-agent-queue-cursor-state verify-multi-agent-queue-cursor-resume-state verify-multi-agent-queue-run-ledger-v0-2 verify-multi-agent-queue-cursor-state-v0-2 verify-multi-agent-queue-cursor-resume-state-v0-2 m21-streamed-authoring-c919-queue-gate m21-streamed-authoring-c919-raw-intake-gate m21-streamed-authoring-c919-real-doc-raw-intake-gate multi-agent-m1-review-package multi-agent-m2-requirement-to-ir-demo multi-agent-m3-safety-evidence-value-pack multi-agent-m4-external-review-handoff multi-agent-construction-control-plane multi-agent-queue-extension-template multi-agent-fast-construction-gate
