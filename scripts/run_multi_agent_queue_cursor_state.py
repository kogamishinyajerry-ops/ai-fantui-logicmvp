...
RESUME_POLICY_ID = "first-approved-open-item-v0.1"
IDLE_REASON = (
    "All approved queue run records are converged; wait for the next append-only queue item."
)
READY_REASON = (
    "An approved open queue run record exists; resume RUN-QUEUE-010 before appending more work."
)
...
OPEN_SOURCE_FINDING_CODE = "CHECK_UNREACHABLE_STATE_001"
