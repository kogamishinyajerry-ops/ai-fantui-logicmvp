...
SCHEDULER_POLICY_ID = "latest-approved-append-only-item-v0.1"
SCHEDULER_REASON = (
    "Use the newest append-only approved queue item after v0.8 checker passes."
)
...
def run_multi_agent_queue_run_ledger(
    *,
    ...
    source_queue = _run_source_queue(
        queue_artifact_dir=artifact_dir / "source-approved-candidate-task-queue-v0-8",
    ...
    deterministic_gates = {
        "source_queue_v0_8_checker": _gate_status(source_queue_valid),
    ...
    payload = {
        ...
        "append_only": {
            ...
            "append_mode": "ledger_records_append_only_v0.1",
        },
        "run_records": records,
