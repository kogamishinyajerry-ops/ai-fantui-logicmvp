#!/usr/bin/env python3
"""Run the approved Evidence unknown-requirement coverage repair slice."""
...
from well_harness.agent_development_slice import (
    ...
    DEFAULT_EVIDENCE_UNKNOWN_REQUIREMENT_ARTIFACT_DIR,
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the approved Evidence Agent unknown-requirement repair slice.",
    )
    parser.add_argument(
        "--artifact-dir",
        type=Path,
        default=DEFAULT_EVIDENCE_UNKNOWN_REQUIREMENT_ARTIFACT_DIR,
...
def main() -> int:
    args = _parse_args()
    payload = run_evidence_unknown_requirement_candidate_repair_slice(
