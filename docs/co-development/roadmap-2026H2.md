...
| ----- | ---- | ---------- | -------- | ---- |
| P23 | Co-development Kit | API 契约 / 安全评审模板 / SLA 草案 / 本路线图 | 1–1.5 工作日 | 立项通过 |
| P24 | 甲方子系统接入 PoC | 甲方选一个子系统，完成 文档→spec→runtime 端到端 | 4–6 周 | P23 完成 |
| P25 | 生产前硬化 | Staging 环境 SLA 达标 + 对抗测试扩展 + 完整审计链 | 4–6 周 | P24 通过 |
| P26 | 首批产线 Validation | 嵌入真实产线流程，第一批结果可追溯 | 6–8 周 | P25 通过 |
| P27 | 季度审计包 | 第三方复核 + 合规报告 + R1–R5 稳定性证明 | 2 周 / 季 | 持续 |

**目标日期（若立项 T₀ 定于 2026-05-01）：**
- P23 完成：T₀ + 2 天
- P24 完成：T₀ + 6 周（2026-06 中旬）
- P25 完成：T₀ + 12 周（2026-07 下旬）
- P26 完成：T₀ + 20 周（2026-09 下旬）= **2026Q3 底交付首批 validation**
- P27 首次执行：2026-10
...
| 里程碑 | 建议付款比例 | 触发条件 |
| ------ | ------------ | -------- |
| P23 完成 | 10% | Co-dev kit 4 份文档签字 |
| P24 完成 | 25% | PoC 子系统演示通过 |
| P25 完成 | 25% | Staging SLA 2 周达标 |
| P26 完成 | 30% | 首批 validation 签字 |
| P27 首期 | 10% | 首个季度审计报告双签 |
