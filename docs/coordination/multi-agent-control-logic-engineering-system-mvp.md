...
| M24 validation/PR preflight gate | Chief Engineer PR Preflight Gate | `make multi-agent-pr-preflight` | M23 package order plus the M24 preflight package are converted into 21 validation commands, 8 explicit stage commands, browser geometry markers, Notion blocker text, and a copy-ready PR body |
