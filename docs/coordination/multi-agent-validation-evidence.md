...
Browser gate: open the generated HTML and verify it shows `Multi-Agent Validation Evidence`, `multi-agent-cursor-baseline-v0-2-01`, `m24-pr-preflight-03`, `m25-validation-evidence`, `notion-control-plane-404`, and `21 validation commands passed` without desktop or mobile layout overflow.
